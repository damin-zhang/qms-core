...
var edit = _language.default.common.edit,
    ...
    fields = _language$systemPlatf.ServiceConfig.fields;
...
var PropertyForm = function PropertyForm(_ref) {
  ...
  var onFinish = function onFinish(values) {
    dispatch({
      type: 'serviceConfig/editSystemconfig',
      payload: {
        values: values,
        record: record
      }
  ...
  return /*#__PURE__*/_react.default.createElement(_DragModal.default, _extends({
    title: edit + ' ' + ServiceConfig.title,
    form: form
  }, restProps, {
    onOk: function onOk() {
      return form.submit();
