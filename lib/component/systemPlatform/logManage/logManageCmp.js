...
var _index = _interopRequireDefault(require("../systemLog/index.less"));
...
var _language$systemPlatf = _language.default.systemPlatform.systemLog,
...
var LogManageCmp = function LogManageCmp(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              state = false;
              _context.next = 3;
              return (0, _api.get)('/log/app/query', {
                action: action,
                page: page,
                pageSize: pageSize
              }).then(function (data) {
  ...
  })), selectedRowKey && selectedRowKey[0] && /*#__PURE__*/_react.default.createElement("div", {
...
var _default = (0, _dva.connect)(mapStateToProps)(LogManageCmp);
