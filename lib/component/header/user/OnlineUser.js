...
var columns = [{
  ...
  render: function render(text) {
    return text ? /*#__PURE__*/_react.default.createElement("span", null, fields.singleSignOnSSO) : /*#__PURE__*/_react.default.createElement("span", null, fields.systemLogin);
  }
}, {
...
var OnlineUser = function OnlineUser(_ref) {
  ...
  var getOnlineUser = function getOnlineUser() {
    (0, _api.get)('/system/user/getOnline').then(function (res) {
      if (res) {
  ...
  var sendMessage = function sendMessage() {
    ...
    (0, _communicationApi.sendNotice)(data).then(function (res) {
      if (res) {
        setSendMessageModalVisible(!sendModalVisible);

        _antd.message.success(notice.message_sent_successfully);
      }
    });
  }; //发送邮件
  ...
  var sendEmail = function sendEmail() {
    ...
    (0, _communicationApi.sendMail)(values).then(function (res) {
      if (res) {
        setSendMessageModalVisible(!sendModalVisible);
  ...
  var toogleSendMessageModal = function toogleSendMessageModal(type) {
    return function () {
      if (selectedRowKeys.length > 0) {
        ...
        _antd.message.warn(prompt_user);
      }
    };
  };
  ...
  footer.push( /*#__PURE__*/_react.default.createElement("div", {
    ...
    value: "1",
    key: 1
  }, notice.plain_text), /*#__PURE__*/_react.default.createElement(Option, {
    value: "0",
    key: 0
  }, notice.rich_text))), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, /*#__PURE__*/_react.default.createElement(_icons.TeamOutlined, {
    onClick: toogleModal,
    style: {
    ...
    }, send_messages)), ",", /*#__PURE__*/_react.default.createElement(_antd.Button, {
      type: "default",
      onClick: toogleModal
    }, close))]
  ...
  }, contentType ? /*#__PURE__*/_react.default.createElement(TextArea, {
    rows: 10
    ...
    name: "senderId",
    label: notice.sender
  }, sendType === 'message' ? /*#__PURE__*/_react.default.createElement(_antd.Input, {
    disabled: true,
    ...
    onFocus: function onFocus() {
      (0, _communicationApi.getSenderMail)().then(function (res) {
        if (res) {
