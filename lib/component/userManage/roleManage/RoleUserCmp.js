...
var common = _language.default.common,
    _language$userManage$ = _language.default.userManage.roleManage.roleUser,
...
var Index = function Index(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return (0, _systemApi.queryAddRoleUser)({
                page: page,
                pageSize: pageSize,
                keyWord: keyWord
              }).then(function (data) {
  ...
  }, /*#__PURE__*/_react.default.createElement(_TableWithBtn.default, tableProp1)));
};
