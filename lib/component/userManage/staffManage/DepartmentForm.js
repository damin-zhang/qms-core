...
var _userSelectForm = _interopRequireDefault(require("../userSelectForm"));
  ...
  return /*#__PURE__*/_react.default.createElement(_DragModal.default, _extends({
    ...
    rules: [{
      ...
      validator: function validator(_, value) {
        return (0, _utils.checkRepeat)(value, 'name', dataList, record.id);
      }
    }]
    ...
    rules: [{
      ...
      validator: function validator(_, value) {
        return (0, _utils.checkRepeat)(value, 'ename', dataList, record.id);
      }
    }]
  }, /*#__PURE__*/_react.default.createElement(_antd.Input, null)), /*#__PURE__*/_react.default.createElement(Item, {
    name: "tel",
    ...
    onCancel: toomodels,
    onOk: selectOk
  }, viseble1 && /*#__PURE__*/_react.default.createElement(_userSelectForm.default, _extends({}, objectProps, {
    ref: childRef,
    form: form,
    editor: 'UserSelector'
  }))));
