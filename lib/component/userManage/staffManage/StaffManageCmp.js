...
var _StaffForm = _interopRequireDefault(require("./StaffForm"));

var _StaffInformation = _interopRequireDefault(require("./StaffInformation"));

var _StaffUserForm = _interopRequireDefault(require("./StaffUserForm"));
...
var columns = [{
  ...
  render: function render(text) {
    return /*#__PURE__*/_react.default.createElement("span", null, text ? '男' : '女');
  }
}, {
  title: fields.INTIME,
  dataIndex: 'inTime',
...
var Index = function Index(_ref) {
  ...
  var btns = [{
    ...
    icon: /*#__PURE__*/_react.default.createElement(_icons.NodeCollapseOutlined, null),
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    onTabClick: callback
  }, selectedRows1[0].deptId && /*#__PURE__*/_react.default.createElement(TabPane, {
    tab: staffUser.title1,
    key: "StaffInformation"
  }, /*#__PURE__*/_react.default.createElement(_StaffInformation.default, {
    ...
    disabled: true
  })))))), selectedRows[0] && /*#__PURE__*/_react.default.createElement(_StaffForm.default, {
    visible: visible1,
    record: record1,
    onCancel: toogleModal(),
    selectedRows: selectedRows
  }), record2 && /*#__PURE__*/_react.default.createElement(_StaffUserForm.default, {
    visible: visible2,
    record: record2,
