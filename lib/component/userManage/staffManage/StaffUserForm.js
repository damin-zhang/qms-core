...
var edit = _language.default.common.edit,
    _language$userManage$ = _language.default.userManage.staffManage.staffUser,
    title = _language$userManage$.title,
...
var PropertyForm = function PropertyForm(_ref) {
  ...
  var onFinish = function onFinish(values) {
    values.SPERSONNELID = record.SPERSONNELID;
    dispatch({
      type: 'StaffManage/editStaffUser',
      payload: {
        values: values,
        record: record
      }
