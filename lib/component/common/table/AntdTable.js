...
var AntdTable = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(AntdTable, [{
    ...
    value: function render() {
        ...
        if (showDetails) {
          var _operationColmun = _objectSpread(_objectSpread({
            ...
            render: function render(text, record) {
              return /*#__PURE__*/_react.default.createElement("div", {
              ...
              }, showSubPage && /*#__PURE__*/_react.default.createElement("a", {
                style: {
                  padding: '0 7px',
                  borderRadius: '2px',
              ...
              }, /*#__PURE__*/_react.default.createElement(_icons.BlockOutlined, null), _utils2.isEnglish ? 'Relation' : '关联'), /*#__PURE__*/_react.default.createElement("a", {
                style: {
                  padding: '0 7px',
                  borderRadius: '2px',
                ...
                className: "ant-dropdown-link",
                onClick: showDetails
              }, /*#__PURE__*/_react.default.createElement(_icons.EyeOutlined, null), _utils2.isEnglish ? 'Detail' : '明细'));
            }
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Table, _extends({
        columns: _columns,
        dataSource: data,
              ...
              if (model && (model.tableName === 'IQC_PENDING_ORDER' || model.tableName === 'IQC_ESSENTIAL_INFORMA' || model.tableName === 'IQC_SAIF')) {
                ...
                var payload = {
                  ...
                  clickedMenu: {
                    ...
                    caption: _utils2.isEnglish ? 'Quality inspection entry' : '质检录入',
                    values: {
