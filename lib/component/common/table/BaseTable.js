...
var _reactBaseTable = _interopRequireDefault(require("react-base-table"));
...
var _AutoResizer = _interopRequireDefault(require("react-base-table/lib/AutoResizer"));
...
var StyledTable = (0, _styledComponents.default)(_reactBaseTable.default)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  .row-selected {\n    color: #333;\n    font-weight: bold;\n    background-color: #cee7fb;\n  }\n  .BaseTable__header-row {\n    // background: #fffff0;\n  }\n  .BaseTable__header-cell-text {\n    white-space: nowrap;\n  }\n  .BaseTable__row-cell {\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n  .BaseTable__row-cell > span {\n    max-width: 100%;\n    overflow: hidden;\n    text-overflow: ellipsis;\n  }\n  .BaseTable__table-frozen-right .BaseTable__header-cell:last-child {\n    padding: 0;\n  }\n  .BaseTable__table .BaseTable__body {\n    ::-webkit-scrollbar {\n      -webkit-appearance: none;\n      background-color: #e3e3e3;\n    }\n\n    ::-webkit-scrollbar:vertical {\n      width: 12px;\n      background-color: #e3e3e3;\n    }\n\n    ::-webkit-scrollbar:horizontal {\n      height: 12px;\n    }\n\n    ::-webkit-scrollbar-thumb {\n      border-radius: 10px;\n      border: 2px solid #e3e3e3;\n      background-color: #999;\n\n      &:hover {\n        background-color: #666;\n      }\n    }\n\n    ::-webkit-resizer {\n      display: none;\n    }\n  }\n"])));
var DraggableContainer = (0, _reactSortableHoc.sortableContainer)(function (_ref) {
  var children = _ref.children;
  return children;
});
var DraggableElement = (0, _reactSortableHoc.sortableElement)(function (_ref2) {
  var children = _ref2.children;
  return children;
});
var DraggableHandle = (0, _reactSortableHoc.sortableHandle)(function (_ref3) {
  var children = _ref3.children;
  return children;
});

var Handle = _styledComponents.default.div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  flex: none;\n  width: 7.5px;\n  height: 100%;\n\n  &::before {\n    content: '';\n    border-left: 4px dotted #ccc;\n    display: block;\n    height: 20px;\n    margin: 5px 3px;\n  }\n\n  &:hover::before {\n    border-color: #888;\n  }\n"])));
...
var Row = function Row(_ref4) {
  ...
  return /*#__PURE__*/_react.default.createElement(DraggableElement, {
    key: key,
    index: index
  }, /*#__PURE__*/_react.default.createElement("div", rest, /*#__PURE__*/_react.default.createElement(DraggableHandle, null, /*#__PURE__*/_react.default.createElement(Handle, null)), children));
};
...
var SelectableTable = /*#__PURE__*/function (_React$PureComponent3) {
  ...
  function SelectableTable(props) {
    ...
    _this4._handleSelectChange = function (_ref5) {
      ...
      if (selectedAll) {
        selectedRows = data[0].hasOwnProperty('PID') ? (0, _utils2.flattenTree)(data) : (0, _utils.cloneArray)(data);
    ...
    _this4._rowClassName = function (_ref6) {
      ...
      var rowClass = rowClassName ? (0, _utils.callOrReturn)(rowClassName, {
        rowData: rowData,
        rowIndex: rowIndex
      }) : '';
      var key = rowData[rowKey];
    ...
    _this4.table = _react.default.createRef();
    ...
    _this4.rowProps = function (args) {
      ...
      var extraProps = (0, _utils.callOrReturn)(_this4.props.rowProps);
    ...
    _this4.rowRenderer = function (_ref9) {
      ...
      if (rowSpan > 1) {
        ...
        cells[rowSpanIndex] = _react.default.cloneElement(cell, {
          style: style
        });
      }
  ...
  _createClass(SelectableTable, [{
    ...
    value: function componentWillUnmount() {
      (0, _contextMenuFunc.hideContextMenu)();
    }
    /**
    ...
    value: function setSelectedRowKeys(selectedRowKeys) {
      ...
      this.setState({
        selectedRowKeys: (0, _utils.cloneArray)(selectedRowKeys)
      });
    }
    /**
    ...
    value: function render() {
        ...
        if (showDetails) {
          var _operationColmun = _objectSpread(_objectSpread({
            ...
            headerRenderer: function headerRenderer() {
              ...
              }, "total"), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("span", null));
            }
          }, selectionColumnProps), {}, {
            key: '__operation__',
            rowKey: this.props.rowKey,
      ...
      return canDrag ? /*#__PURE__*/_react.default.createElement(DraggableContainer, {
        useDragHandle: true,
        getContainer: this.getContainer,
        helperContainer: this.getHelperContainer,
        onSortEnd: this.handleSortEnd
      }, /*#__PURE__*/_react.default.createElement(StyledTable, _extends({}, rest, {
        columns: _columns,
...
SelectableTable.defaultProps = _objectSpread(_objectSpread({}, _reactBaseTable.default.defaultProps), {}, {
  columns: [],
  data: []
...
SelectableTable.propTypes = {
  ...
  rowSelection: _propTypes.default.exact({
  ...
  // 是否可拖拽表格行
  moveRow: _propTypes.default.func // 拖拽表格行之后触发事件
...
var _default = function _default(_ref10) {
  ...
  return /*#__PURE__*/_react.default.createElement(_AutoResizer.default, null, function (_ref11) {
    ...
    return /*#__PURE__*/_react.default.createElement(SelectableTable, _extends({
