...
var common = _language.default.common,
    fields = _language.default.activiti.Process_instance.fields;
...
var ProcessInstanceList = function ProcessInstanceList(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return (0, _processApi.searchProcdefProcess)({
                page: page,
                pageSize: pageSize,
                keyWord: keyWord
              }).then(function (data) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_DragModal.default, {
    ...
    className: "flex-y"
  }, /*#__PURE__*/_react.default.createElement(_TableWithBtn.default, props))), /*#__PURE__*/_react.default.createElement(_antd.Drawer, {
    placement: "bottom",
    title: fields.processPng,
    visible: visiblePng,
    onClose: onCancel,
...
var _default = (0, _dva.connect)(mapStateToProps)(ProcessInstanceList);
