...
var CutRoundBarTraceCmp = function CutRoundBarTraceCmp(_ref) {
  ...
  var RoundBarHeader = /*#__PURE__*/_react.default.createElement(_antd.Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Drawer, {
    ...
    data: _DetailHeadInfo.RoundBarInfo,
    init: parameterMsgList,
    color: "#69B2EF"
  })), sampleMsgList && sampleMsgList.length( /*#__PURE__*/_react.default.createElement(Panel, {
    ...
    data: _DetailHeadInfo.samplePieceInfo,
    init: sampleMsgList,
    color: "#69B2EF"
  }))), /*#__PURE__*/_react.default.createElement(Panel, {
    header: cutHeader,
...
var _default = (0, _dva.connect)(mapStateToProps)(CutRoundBarTraceCmp);
