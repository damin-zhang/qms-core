...
var SketchyBarTraceCmp = function SketchyBarTraceCmp(_ref) {
  ...
  var squareBarMsgList = detailList.squareBarMsgList,
      squareBarSampleMsgList = detailList.squareBarSampleMsgList,
      squareBarReverseCutMsgList = detailList.squareBarReverseCutMsgList;
  ...
  var parameterHeader = /*#__PURE__*/_react.default.createElement(_antd.Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
  ...
  }, "\u65B9\u68D2\u53C2\u6570\u4FE1\u606F"), isShow.some(function (item) {
  ...
  var samplePieceHeader = /*#__PURE__*/_react.default.createElement(_antd.Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
  ...
  var cutHeader = /*#__PURE__*/_react.default.createElement(_antd.Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Drawer, {
    ...
    columns: _DetailHeadInfo.parameterInfo,
    dataSource: squareBarMsgList,
    pagination: false,
    bordered: true,
    size: "small",
    style: {
    ...
    data: _DetailHeadInfo.squareSamplePieceInfo,
    init: squareBarSampleMsgList,
    color: "#69B2EF"
  })), /*#__PURE__*/_react.default.createElement(Panel, {
    header: cutHeader,
    key: 3,
    ...
    data: _DetailHeadInfo.squareCutInfo,
    init: squareBarReverseCutMsgList,
    color: "#69B2EF"
  }))))));
};

function mapStateToProps(_ref2) {
  var squareBarTraceCmp = _ref2.squareBarTraceCmp;
