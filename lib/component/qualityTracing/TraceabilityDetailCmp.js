...
var TraceabilityDetailCmp = function TraceabilityDetailCmp(_ref) {
  ...
  var supplierHeader = /*#__PURE__*/_react.default.createElement(_antd.Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
  ...
  var purchaseHeader = /*#__PURE__*/_react.default.createElement(_antd.Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Drawer, {
    ...
    columns: _DetailHeadInfo.checkingInfo,
    ...
    data: _DetailHeadInfo.supplierInfo,
    init: supplierData,
    color: "#69B2EF"
  })), /*#__PURE__*/_react.default.createElement(Panel, {
    ...
    data: _DetailHeadInfo.purchaseInfo,
    init: purorderList,
    color: "#69B2EF"
  })), /*#__PURE__*/_react.default.createElement(Panel, {
    ...
    data: _DetailHeadInfo.receivingInfo,
    init: receivingList,
    color: "#69B2EF"
  }))))));
};
...
var _default = (0, _dva.connect)(mapStateToProps)(TraceabilityDetailCmp);
