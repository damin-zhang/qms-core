...
var _OutreachField = _interopRequireDefault(require("./OutreachField"));
...
var edit = _language.default.common.edit,
    _language$configPlatf = _language.default.configPlatform.queryView,
...
var QueryViewForm = function QueryViewForm(_ref) {
  ...
  var getGridList = function getGridList(objectNo) {
    (0, _metaApi.queryItemPGR)({
      tn: (0, _queryTabConfigRelationApi.queryModelMap)('META_OBJECT_GRID'),
      tableName: objectNo
    }).then(function (res) {
  ...
  }), /*#__PURE__*/_react.default.createElement(_antd.Input.TextArea, null)), /*#__PURE__*/_react.default.createElement(_OutreachField.default, {
    form: form
  }), /*#__PURE__*/_react.default.createElement(_LocaleNameForm.default, null)));
};

var _default = (0, _dva.connect)()(QueryViewForm);
