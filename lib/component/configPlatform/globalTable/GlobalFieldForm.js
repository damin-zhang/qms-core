...
var edit = _language.default.common.edit,
    _language$configPlatf = _language.default.configPlatform.globalTable.globalField,
...
var GridItemForm = function GridItemForm(_ref) {
  ...
  var onFinish = function onFinish(values) {
    ...
    if (record.GTYPE === 2) values.PARAMS = JSON.stringify(values.PARAMS);
    dispatch({
  ...
  }))), record.GTYPE === 2 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(Item, _extends({
