...
var _GridSetForm = _interopRequireDefault(require("./GridSetForm"));

var _GridItemForm = _interopRequireDefault(require("./GridItemForm"));

var _GridPreview = _interopRequireDefault(require("./GridPreview"));
...
var Grid = function Grid(_ref) {
    ...
    render: function render(text, record) {
      ...
      if (text.length) {
        for (var i = 0; i < text.length; i++) {
          if (i !== text.length - 1) {
            str += _mapParams.gridOperation[text[i]].name + '，';
          } else str += _mapParams.gridOperation[text[i]].name;
        }
      } else str = '明细';
  ...
  var objectColumns = [{
    ...
    width: 60,
    render: function render(text) {
      var fType = _utils.isEnglish ? _EnMapParams.gTypeMap.find(function (item) {
        return item.value === text;
      }) : _mapParams.gTypeMap.find(function (item) {
        return item.value === text;
      });
      return fType ? text ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    form: form,
    component: false
  }, /*#__PURE__*/_react.default.createElement(_TableWithBtn.default, objectProps))), /*#__PURE__*/_react.default.createElement(_GridForm.default, formProps), /*#__PURE__*/_react.default.createElement(_GridItemForm.default, objectFormProps), /*#__PURE__*/_react.default.createElement(_GridSetForm.default, setFormProps), /*#__PURE__*/_react.default.createElement(_GridPreview.default, objectPreview), /*#__PURE__*/_react.default.createElement(_DragSortForm.default, dragProps));
};
