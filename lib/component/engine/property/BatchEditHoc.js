...
var EditableCell = function EditableCell(_ref) {
  ...
  var inputNode = /*#__PURE__*/_react.default.createElement(_antd.Input, null); // let inputNode = <EditorCmp pageFieldList={[{ no: dataIndex, editor, editParams }]} list={list} />


  if (editor === 'ValueList') {
    inputNode = /*#__PURE__*/_react.default.createElement(_antd.Select, {
      showSearch: canInput
    ...
    inputNode = /*#__PURE__*/_react.default.createElement(_antd.Select, null, (list[dataIndex] || []).map(function (item, index) {
      return /*#__PURE__*/_react.default.createElement(Option, {
        value: item.NAME,
        key: index
      }, item.NAME);
    ...
    inputNode = /*#__PURE__*/_react.default.createElement(_antd.Input.TextArea, {
      rows: rowHeight
    });
  }
...
var TableHoc = function TableHoc(engine) {
  return function (WrappedComponent) {
    var EditableTable = function EditableTable(_ref2, ref) {
      ...
      var _useState = (0, _react.useState)(record || []),
    ...
    return (0, _react.forwardRef)(EditableTable);
  };
};
