...
var fields = _language.default.userManage.staffManage.fields;
...
var UserSelectorForm = function UserSelectorForm(_ref, ref) {
  ...
  (0, _react.useEffect)(function () {
    if (editParams) {
      ...
      (0, _systemApi.deptQuery)().then(function (res) {
        if (res) {
        ...
        if (rows.length > 0) {
          if (editor === 'UserSelector') {
            ...
            if (selectMap === 1) {
              ...
              result[tfield] = _utils.isEnglish ? mapList.name : mapList.ename;
            }
  ...
  var loop = function loop(data) {
    ...
    return data.map(function (item) {
      var name = item.name,
          id = item.id,
          ename = item.ename;
      var NAMEPRO = _utils.isEnglish ? ename || name : name || ename;

      var title = /*#__PURE__*/_react.default.createElement("span", null, NAMEPRO);
  ...
  }, /*#__PURE__*/_react.default.createElement(_TableWithBtn.default, userProp))));
};
