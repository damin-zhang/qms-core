...
var _default = function _default(_ref) {
  ...
  var _useState7 = (0, _react.useState)(['1', '297EDFF872DA192F0172DA1E2AB00004']),
  ...
  var onSelect = function onSelect(selectedKeys, e) {
    ...
    if (type === 'departmentManage' || type === 'staffManage') {
      if (selectedNode.id === selectedRows[0].pid) {
        _antd.message.warning(cannot_select_root_node);
  ...
  }, type === 'departmentManage' || type === 'staffManage' ? loop((0, _utils.systemErgodicRoot)(list || [])) : loop((0, _utils.ergodicRoot)(list || []))));
};
