...
var RohsInspectionEntry = function RohsInspectionEntry(_ref) {
  ...
  var onInputPressEnter = function onInputPressEnter(record, fieldName, index) {
    ...
    if (isNaN(Number(value))) {
      _antd.message.warning('输入的数据格式不正确!');

      return;
    } else if (Number(value) < 0) {
      _antd.message.warning('请输入正确的数值!');
              ...
              if (res && res.flag === true) {
                val = {
                  ...
                  data: {
                    ...
                    UPTIME: (0, _dataToFormat.dateToFormat)(new Date())
                  }
                };
                (0, _utils.showLoading)();
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 1:
              ...
              _antd.message.warning('单号' + dataList[i].NO + '没有上传测试报告');
            ...
            case 5:
              ...
              _antd.message.warning('单号' + dataList[i].NO + '没有录入测试结果');
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 1:
              ...
              _antd.message.warning('单号' + selectedRows[i].NO + '没有上传测试报告');
  ...
  }, "\u6279\u91CFNG")), /*#__PURE__*/_react.default.createElement("div", {
    style: {
...
var _default = (0, _dva.connect)(mapStateToProps)(RohsInspectionEntry);
