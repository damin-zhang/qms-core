...
var _index = _interopRequireDefault(require("../tab/index.less"));
...
var _CustomBrowseFiles = _interopRequireDefault(require("../customWindow/CustomBrowseFiles"));
...
var ReverseRualityReport = function ReverseRualityReport(_ref) {
  ...
  var columns = [{
    ...
    render: function render(text, record) {
      return /*#__PURE__*/_react.default.createElement("span", null, record.AC + '/' + record.RE);
    }
  }, {
    title: '检验结果',
    dataIndex: 'TR',
    ...
    render: function render(text, record) {
      if (record && record.list && record.list.length > 3) {
        return /*#__PURE__*/_react.default.createElement(_antd.Select, {
          ...
          return item.NO > 3 && /*#__PURE__*/_react.default.createElement(Option, {
            disabled: true,
            key: index,
            style: {
      ...
      } else return /*#__PURE__*/_react.default.createElement("p", {
        style: {
  ...
  var getTable = function getTable(fieldData, footer, list) {
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("table", {
      ...
      return /*#__PURE__*/_react.default.createElement("tr", {
        ...
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("td", {
          ...
          rowSpan: td.rowSpan
        }, td.name), /*#__PURE__*/_react.default.createElement("td", {
          style: {
    ...
    }), footer && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("tr", {
      style: {
        width: '100%'
      }
      ...
      value: 'A',
      disabled: true
    }, "\u5408\u683C\u63A5\u6536"), /*#__PURE__*/_react.default.createElement(Option, {
      value: 'C'
    }, "\u7279\u91C7\u8DDF\u8E2A\u4F7F\u7528"), /*#__PURE__*/_react.default.createElement(Option, {
      value: 'B'
    }, "\u7279\u91C7\u76F4\u63A5\u4F7F\u7528"), /*#__PURE__*/_react.default.createElement(Option, {
      value: 'D'
    }, "SQE\u76F4\u63A5\u62A5\u5E9F"), /*#__PURE__*/_react.default.createElement(Option, {
      value: 'E'
    }, "\u9A73\u56DE\u5230IQC"), /*#__PURE__*/_react.default.createElement(Option, {
      value: 'F',
      disabled: true
    }, "\u5408\u683C"))), /*#__PURE__*/_react.default.createElement(Item, {
    ...
    }), /*#__PURE__*/_react.default.createElement(_SearchSelect.default, {
      name: "CARBON_COPY",
      className: "whole-line",
    ...
    }, /*#__PURE__*/_react.default.createElement("span", null, "\u68C0\u9A8C\u5458\uFF1A", getFieldVal('FI', footerList)), /*#__PURE__*/_react.default.createElement("span", null, "\u5BA1\u6838\uFF1A", getFieldVal('TEAML', footerList))))))));
  };
  ...
  var exportEXCEL = function exportEXCEL() {
    ...
    (0, _utils.showLoading)();
    (0, _uploadApi.exportExcel)(params).then(function (res) {
      if (res && res.flag === false) {
        _antd.message.warn('导出失败');
      }
    }).catch(function (err) {});
  };
  ...
  var exportPDF = function exportPDF() {
    ...
    (0, _utils.showLoading)();
    (0, _uploadApi.exportPdf)(params).then(function (res) {
      if (res && res.flag === false) {
        _antd.message.warn('导出失败');
      }
    }).catch(function (err) {});
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
    onClick: exportEXCEL
  }, "\u5BFC\u51FAExcel"), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    onClick: exportPDF
  }, "\u5BFC\u51FAPDF"), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    onClick: downloadAttachment
  }, "\u9644\u4EF6"), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    ...
    className: _index.default.R_header
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)([_index.default.logo])
  }), /*#__PURE__*/_react.default.createElement("div", {
    className: _index.default.R_title
  }, /*#__PURE__*/_react.default.createElement("span", {
    style: {
      display: 'inline-block',
      width: '170px'
    }
  }, "\u9510\u6377\u7F51\u7EDC\u9006\u5411\u8D85\u671F\u68C0\u9A8C\u62A5\u544A"))), /*#__PURE__*/_react.default.createElement("div", null, getTable(tableHeader, false, list)), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      width: '100%'
    }
    ...
    bordered: true,
    pagination: false,
    className: _index.default.table_break_spaces
  }), footerList.length && footerList[0].TEST_CONCLUSION === 'NG' && /*#__PURE__*/_react.default.createElement("div", null, getTable(tableFooter, true, list)))), /*#__PURE__*/_react.default.createElement(_DragModal.default, {
    zIndex: 1100,
  ...
  }, /*#__PURE__*/_react.default.createElement(_userSelectForm.default, _extends({
    ref: childRef
  }, objectProps))), /*#__PURE__*/_react.default.createElement(_antd.Modal, {
    title: "\u9644\u4EF6",
    ...
    footer: false,
    className: _index.default.lookFile
  }, /*#__PURE__*/_react.default.createElement(_CustomBrowseFiles.default, {
    file: file,
    record: fileRecord
  })));
};
...
var _default = (0, _dva.connect)(mapStateToProps)(ReverseRualityReport);
