...
var _CustomBrowseFiles = _interopRequireDefault(require("./CustomBrowseFiles"));
...
var RohsReport = function RohsReport(_ref) {
  ...
  var definitionColumns = [{
    ...
    render: function render(text) {
      return /*#__PURE__*/_react.default.createElement("span", null, SUPPLIER_RISK_LEVEL[text]);
    }
  }, {
    title: '物料风险等级',
    ...
    width: 120,
    render: function render(text) {
      return /*#__PURE__*/_react.default.createElement("span", null, COMPREHENSIVE_RISK_DETERMINATION[text]);
    }
  }, {
    title: '测试报告',
    dataIndex: 'FNAME',
    ...
    render: function render(text, record, index) {
      ...
      }, "\u67E5\u770B"), /*#__PURE__*/_react.default.createElement(_antd.Button, {
        onClick: function onClick() {
            ...
            case 3:
              ...
              if (res && res.flag) {
                ...
                if (type === 'look') {
                  ...
                  (0, _utils.showLoading)();
                  (0, _uploadApi.downloadFiles)(_objectSpread({}, val)).then(function (res) {
                    (0, _utils.hideLoading)();
                  });
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
  ...
  }, reportList && reportList.length && reportList[0].TR === 'NG' && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      width: '100%',
      paddingTop: '20px'
    }
    ...
    value: '供应商责任'
  }, "\u4F9B\u5E94\u5546\u8D23\u4EFB"), /*#__PURE__*/_react.default.createElement(Option, {
    value: '退回重检'
  }, "\u9000\u56DE\u91CD\u68C0"))), /*#__PURE__*/_react.default.createElement(Item, {
    name: "SQE_CONCLUSION",
    label: "SQE\u7ED3\u8BBA",
    rules: [{
      required: true
    ...
    ref: childRef
  }, objectProps))), /*#__PURE__*/_react.default.createElement(_antd.Drawer, {
    title: "\u67E5\u770B\u6587\u4EF6",
    onClose: onCancel,
    visible: bfVisible,
    width: "70%"
...
var _default = (0, _dva.connect)(mapStateToProps)(RohsReport);
