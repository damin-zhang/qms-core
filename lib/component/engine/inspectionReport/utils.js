...
exports.setInspectionColumns = void 0;
  ...
  var columns = fieldsList.map(function (item) {
    ...
    var render = function render(h, record, i) {
      ...
      switch (item.EDITOR) {
        ...
        case 'MapValueList':
          Cmp = /*#__PURE__*/_react.default.createElement("div", null, EDITPARAMS.values.filter(function (item) {
  ...
  var _loop = function _loop(i) {
    columns.push({
      ...
      render: function render(h, record, index) {
        var Cmp = /*#__PURE__*/_react.default.createElement("div", {
        ...
        if ((i < 2 || record.InspectionItemResult.length === 3) && Number(record.InspectionItem.DT)) {
          if (record.InspectionItem.MAX_MIN) {
            ...
            }, /*#__PURE__*/_react.default.createElement("span", null, "V:"), record.InspectionItemResult[i].TV), /*#__PURE__*/_react.default.createElement("p", {
            ...
            }, /*#__PURE__*/_react.default.createElement("span", null, "U:"), record.InspectionItemResult[i].UMAX), /*#__PURE__*/_react.default.createElement("p", {
            ...
            }, /*#__PURE__*/_react.default.createElement("span", null, "L:"), record.InspectionItemResult[i].LMIN));
          } else {
            Cmp = /*#__PURE__*/_react.default.createElement("div", {
          ...
          if (record.InspectionItem.SQ > i && Number(record.InspectionItem.DT || modelData.COUNTTYPECANINPUT)) {
            if (record.InspectionItem.MAX_MIN) {
              Cmp = /*#__PURE__*/_react.default.createElement(_antd.Select, {
                defaultValue: 'more',
                ...
                return /*#__PURE__*/_react.default.createElement(_antd.Select.Option, {
                  ...
                  className: "max_min_item"
                }, /*#__PURE__*/_react.default.createElement("p", null, item.NO), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("p", {
                  className: item && item.TR === 'NG' ? 'ng-cell' : null
                }, /*#__PURE__*/_react.default.createElement("span", null, "V:"), item.TV), /*#__PURE__*/_react.default.createElement("p", {
                  className: item && item.UMAX && (item.UMAX > record.InspectionItem.UT || item.UMAX < -record.InspectionItem.LT) ? 'warn-cell' : null
                }, /*#__PURE__*/_react.default.createElement("span", null, "U:"), item.UMAX), /*#__PURE__*/_react.default.createElement("p", {
                  className: item && item.LMIN && (item.LMIN > record.InspectionItem.UT || item.LMIN < -record.InspectionItem.LT) ? 'warn-cell' : null
                }, /*#__PURE__*/_react.default.createElement("span", null, "L:"), item.LMIN))));
              }));
            } else {
              Cmp = /*#__PURE__*/_react.default.createElement(_antd.Select, {
                defaultValue: "more",
                ...
                return /*#__PURE__*/_react.default.createElement(_antd.Select.Option, {
                  ...
                  className: "title"
                }, item.NO), /*#__PURE__*/_react.default.createElement("p", {
