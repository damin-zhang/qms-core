...
var _InspectionHeader = _interopRequireDefault(require("./InspectionHeader"));
...
var _language$enterInput$ = _language.default.enterInput.inspection,
...
var ReportCmp = function ReportCmp(_ref) {
  ...
  (0, _react.useEffect)(function () {
    setColumns((0, _utils2.setInspectionColumns)({
      fieldsList: body,
      dataList: dataList,
      modelData: data,
  ...
  var exportEXCEL = function exportEXCEL() {
    ...
    (0, _uploadApi.exportExcel)(params).then(function (res) {
      ...
      if (res && res.flag === false) {
        _antd.message.warn(report.export_failed);
      }
    }).catch(function (err) {});
  }; // 导出PDF
  ...
  var onFieldSelectChange = function onFieldSelectChange(checkedValues) {
    if (checkedValues.length > 6) {
      _antd.message.warning(_utils.isEnglish ? 'Only 6 export fields can be selected!' : '只能选择6个导出字段!');
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    type: "primary"
  }, report.expoer_excel), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    icon: /*#__PURE__*/_react.default.createElement(_icons.DownloadOutlined, null),
    onClick: function onClick() {
      return fieldSelect('2');
    },
    type: "primary"
  }, report.expoer_pdf)), newRowData && newRowData.D_STATE === 'D' && newRowData.STATE === 0 && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
    type: "primary",
    onClick: function onClick() {
      return startFlow('A');
    }
  }, report.start_flow), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    type: "primary",
    onClick: function onClick() {
      return setShowNote(true);
    }
  }, report.reject_recalibration))), /*#__PURE__*/_react.default.createElement(_InspectionHeader.default, {
    data: data,
    header: header,
    ...
    id: "report-footer"
  }, newRowData && newRowData.TEST_CONCLUSION === 'NG' && /*#__PURE__*/_react.default.createElement("div", {
    className: "footer-ng"
  }, /*#__PURE__*/_react.default.createElement(_ReportFooter.default, {
    data: data,
    footer: footer,
    hData: newRowData || hData
  ...
  }, report.sqe_notes, ":"), /*#__PURE__*/_react.default.createElement(_antd.Input.TextArea, {
    value: SQE_NOTES,
    onChange: function onChange(e) {
      setSQE_NOTES(e.target.value);
    },
    rows: 3
  }))), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_DragModal.default, {
    title: "".concat(_utils.isEnglish ? 'report' : '导出').concat(exportType === '1' ? 'Excel' : 'PDF').concat(report.fieldSelect),
  ...
  }, _utils.isEnglish ? 'Choose 6 export fields' : '请选择6个导出字段', ":"), /*#__PURE__*/_react.default.createElement(_antd.Checkbox.Group, {
    onChange: onFieldSelectChange,
    value: fieldList
  }, /*#__PURE__*/_react.default.createElement(_antd.Row, null, body && body.map(function (item) {
...
var _default = (0, _dva.connect)(mapStateToProps)(ReportCmp);
