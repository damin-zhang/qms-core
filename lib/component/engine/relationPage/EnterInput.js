...
var calculation = function calculation(value, max, min, upper, lower) {
  ...
  if (isNumber(max) && isNumber(min) && upper && lower) {
    if (isNumber(_lodash.default.toNumber(value))) {
      if (upper === '<' || upper === '<=') {
        if (upper === '<') {
          if (lower === '>') {
      ...
      _antd.message.warn(arabic_numerals_message);
    }
  } else {
...
var EnterInput = /*#__PURE__*/function (_React$Component) {
  ...
  function EnterInput(props) {
    ...
    _this.onPressEnter = function (e) {
      ...
      if (clickSubmit) {
        _antd.message.warn(inspection_completed_message);

        return;
      }

      if (!data || data.length === 0) {
        _antd.message.warn(start_input_message);
      ...
      if (value) {
        ...
        var valueNumber = _lodash.default.toNumber(value);
        ...
        if (IS_DR && IS_DR === 1) {
          // 流水号格式化
          var SAMPLE_NUMBER = (0, _utils.formatFillString)(y + 1, 3);
          data[x][y] = {
          ...
          if (SAMPLNUM > 0) {
            // 流水号格式化
            var _SAMPLE_NUMBER = (0, _utils.formatFillString)(y + 1, 3);
        ...
        if (_this.judgeInputCompleteNumber(data) === _this.inspectObjects.length) {
          _antd.message.warn(input_complete_message);
        }
    ...
    _this.cacheData = function (data) {
      ...
      (0, _applicationApi.commonApi)(params).catch(function (err) {// console.log(err)
      });
    };
    ...
    _this.onSubmit = function () {
      ...
      if (number === _this.inspectObjects.length) {
        ...
        _antd.message.warn(please_complete_the_entry);
      }
    };
      ...
      (0, _applicationApi.commonApi)(params).then(function (res) {
        if (res) {
          ...
          inspectObjects.forEach(function (item, j) {
            ...
            if (SAMPLNUM <= 0) {
              _antd.message.error('【' + NAME + '】' + sampling_number_of_inspection_objects);
            }
            ...
            if (IS_DR && IS_DR === 1) {
              if (cacheDataObject !== null) {
                cacheDataObject.forEach(function (result, index) {
                  ...
                  var valueNumber = _lodash.default.toNumber(result.INSRESULT);

                  snumberArr[index] = {
                    SAMPLE_NUMBER: (0, _utils.formatFillString)(index + 1, 3),
      ...
      return function () {
        ...
        data[x].forEach(function (item, j) {
          data[x][j] = _objectSpread(_objectSpread({}, data[x][j]), {}, {
            SAMPLE_NUMBER: (0, _utils.formatFillString)(j + 1, 3),
            SAMPLESN: '',
            INSRESULT: val,
            RESULTREMARK: val,
    ...
    _this.clearMenu = function (data) {
      return /*#__PURE__*/_react.default.createElement(_antd.Menu, null, /*#__PURE__*/_react.default.createElement(_antd.Menu.Item, null, /*#__PURE__*/_react.default.createElement("a", {
        onClick: _this.clearAllCache,
        disabled: _this.judegeClearBtnDisabled(data, 0)
      }, clear_all), /*#__PURE__*/_react.default.createElement("a", {
    ...
    _this.batchMenu = function (data, MAXVAL, MINVAL) {
      ...
      }, batch_input_ok), /*#__PURE__*/_react.default.createElement("a", {
        onClick: _this.batchInput('NG'),
        disabled: !(data && data[0]) || typeof MAXVAL === 'number' && typeof MINVAL === 'number'
      }, batch_input_ng), /*#__PURE__*/_react.default.createElement("a", {
    ...
    _this.clearItemCache = function (clearCache) {
      (0, _utils.confirm)({
        ...
        onOk: function onOk() {
          ...
          (0, _applicationApi.commonApi)(params).then(function (res) {
            if (res.flag) {
              _antd.message.info(cleared_successfully);
    ...
    _this.getCellData = function (objectField, selectedRow) {
      ...
      if (editor === 'MapValueList' || editor === 'ValueList' || editor === 'RadioEditor' || editor === 'CheckEditor') {
        ...
        if (num !== -1) {
          ...
          return color && !showTooltip ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
            style: {
              position: 'relative',
              top: 5
            },
  ...
  _createClass(EnterInput, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        className: _enterInput.default.main
      }, selectedRows && selectedRows.length && visibleSelectedRow && /*#__PURE__*/_react.default.createElement("ul", {
        className: _enterInput.default.selectedRow
      }, gridFieldList.map(function (objectField, index) {
        return /*#__PURE__*/_react.default.createElement("li", {
          key: index
        }, _utils.isEnglish ? objectField.enName : objectField.name, "\uFF1A", /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
          title: _this2.getCellData(objectField, selectedRows[0], true)
        }, _this2.getCellData(objectField, selectedRows[0])));
      })), visibleSelectedRow ? /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
        title: collapse_selected_row
      }, /*#__PURE__*/_react.default.createElement(_icons.CaretUpOutlined, {
        onClick: function onClick() {
          return _this2.setState({
            visibleSelectedRow: false
          });
        },
        className: _enterInput.default.shrinkIcon
        ...
        className: _enterInput.default.expandIcon
      ...
      }, this.showScrollIcon(data, isFirst, disabledSampleSnInput) && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
        title: scroll_to_top
      }, /*#__PURE__*/_react.default.createElement(_icons.CaretUpOutlined, {
        onClick: function onClick() {
          return _this2.scrollContainer('top');
        },
        className: _enterInput.default.scrollTopIcon
      })), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
        ...
        className: _enterInput.default.scrollBottomIcon
      }))), /*#__PURE__*/_react.default.createElement("div", {
        style: {
          width: '100%',
          display: 'flex',
        ...
        suffix: /*#__PURE__*/_react.default.createElement(_antd.Switch, {
      ...
      }, isFirst ? start_input : refresh_cache), /*#__PURE__*/_react.default.createElement(_antd.Button, {
        type: "primary",
        style: {
          marginRight: '-100px'
        },
      ...
      }, save_input), /*#__PURE__*/_react.default.createElement(_antd.Dropdown, {
        overlay: this.clearMenu(data),
        placement: "bottomCenter"
      }, /*#__PURE__*/_react.default.createElement(_antd.Button, null, clear_menu)), /*#__PURE__*/_react.default.createElement(_antd.Dropdown, {
        overlay: this.batchMenu(data, MAXVAL, MINVAL),
        placement: "bottomCenter"
      }, /*#__PURE__*/_react.default.createElement(_antd.Button, null, batch_menu)))), /*#__PURE__*/_react.default.createElement("div", {
        className: _enterInput.default.inspectItemsWrapper,
        ref: function ref(ele) {
        ...
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          className: _enterInput.default.inspectItemName
        }, /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
          title: inspectObjects && inspectObjects[j].NAME
        }, /*#__PURE__*/_react.default.createElement("span", null, inspectObjects && inspectObjects[j].NAME), inspectObjects && inspectObjects[j].IS_DR === 1 && /*#__PURE__*/_react.default.createElement("span", null, "(", no_control_sample_number, ")"))), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
        ...
        }, inspectObjects[j].IS_DPD === 0 ? _this2.getEnteredOkDataNumber(i) : _this2.getEnteredDataNumber(i)), /*#__PURE__*/_react.default.createElement("span", null, "/"), /*#__PURE__*/_react.default.createElement("span", {
          style: {
            color: 'red'
          }
        }, inspectObjects[j].IS_DPD === 0 ? _this2.getEnteredDataNumber(i) - _this2.getEnteredOkDataNumber(i) : '0'), "\xA0", /*#__PURE__*/_react.default.createElement("span", {
          style: {
            color: 'green'
          }
        }, "(", inspectObjects[j].SAMPLNUM, ")"))))), /*#__PURE__*/_react.default.createElement("div", {
          style: {
            display: 'flex'
          }
        }, /*#__PURE__*/_react.default.createElement("span", {
        ...
        }, inspectObjectFields.SAMPLE_NUMBER), disabledSampleSnInput ? '' : /*#__PURE__*/_react.default.createElement("span", {
          style: {
            flex: 2
          }
        }, inspectObjectFields.SAMPLESN), /*#__PURE__*/_react.default.createElement("span", {
          style: {
            flex: 1
          }
        }, inspectObjectFields.INSRESULT), /*#__PURE__*/_react.default.createElement("span", {
          style: {
            flex: 1,
            textAlign: 'right'
          }
        }, inspectObjectFields.RESULTREMARK)), /*#__PURE__*/_react.default.createElement("div", {
          style: {
            flexGrow: 1,
            overflowY: 'auto'
          },
          ...
          }, "key", index), /*#__PURE__*/_react.default.createElement("span", {
            style: {
              flex: 1
            }
          }, item.SAMPLE_NUMBER), disabledSampleSnInput ? '' : /*#__PURE__*/_react.default.createElement("span", {
            style: {
              flex: 2
            }
          }, item.SAMPLESN), /*#__PURE__*/_react.default.createElement("span", {
            style: {
              flex: 1
            }
          }, item.INSRESULT), /*#__PURE__*/_react.default.createElement("span", {
            style: {
              textAlign: 'right',
      ...
      }))), data && data[0] && /*#__PURE__*/_react.default.createElement("div", {
        className: _enterInput.default.tipWrapper
      }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("p", {
        style: {
          color: 'red'
        }
      }, '当前操作：' + NAME + ', 第' + (y + 1) + '行'), /*#__PURE__*/_react.default.createElement("p", null, inspectObjectTip.inspection_equipment, INSPEC_INSTRUMENT), /*#__PURE__*/_react.default.createElement("p", null, inspectObjectTip.upper_limit, isNumber(TARVALUE) && (MAXVAL && UPPERLIMITCOMPARISON !== null ? UPPERLIMITCOMPARISON + MAXVAL : inspectObjectTip.missing_upper_limit_or_calculator)), /*#__PURE__*/_react.default.createElement("p", null, inspectObjectTip.target_value, TARVALUE && TARVALUE), /*#__PURE__*/_react.default.createElement("p", null, inspectObjectTip.lower_limit, isNumber(TARVALUE) && (MAXVAL && LOWERLIMITCOMPARISON !== null ? LOWERLIMITCOMPARISON + MINVAL : inspectObjectTip.missing_lower_limit_or_calculator)), /*#__PURE__*/_react.default.createElement("p", null, inspectObjectTip.determination, IS_DPD === 0 ? '必须' : '非必须')), /*#__PURE__*/_react.default.createElement("div", {
        style: {
          whiteSpace: 'pre-line'
        }
      }, inspectObjectTip.color_box_desc))), /*#__PURE__*/_react.default.createElement(_DragModal.default, {
...
var _default = (0, _dva.connect)()(EnterInput);
