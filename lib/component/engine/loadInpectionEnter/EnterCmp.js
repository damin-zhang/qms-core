...
var _InspectionHeader = _interopRequireDefault(require("../inspectionReport/InspectionHeader"));
...
var EnterCmp = function EnterCmp(_ref) {
  ...
  var _useState3 = (0, _react.useState)(hData[0].ENTRY_END || hData[0].D_STATE !== 'B'),
  ...
  var _useState23 = (0, _react.useState)(body),
  ...
  var _useState31 = (0, _react.useState)(20),
  ...
  (0, _react.useEffect)(function () {
    ...
    setColumns((0, _utils.setInspectionColumns)({
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 8:
              ...
              _antd.message.warning("".concat(i + 1).concat(inspection.inspectionItem, ": ").concat(InspectionItem.PD, " ").concat(inspection.incompleteEntry, "!"));
            ...
            case 15:
              ...
              _antd.message.warning("".concat(inspection.inspectionItem, ": ").concat(InspectionItem.PD, " ").concat(inspection.selectCategory, "!"));
            ...
            case 27:
              ...
              if (res && res.flag === true) {
                ...
                _antd.message.success(res.hint);
              }
  ...
  var onInputPressEnter = function onInputPressEnter(e, record, coordinate, field) {
    ...
    if (value === null || value === undefined || !value.toString()) {
      _antd.message.warning("".concat(inspection.inputTestValue, "!"));
    ...
    if (value === 'NAN') {
      _antd.message.warning("".concat(inspection.formalError, "!"));
    ...
    if (field === 'TV') {
      ...
      if (value > UT) {
        var td = Number((0, _mathjs.format)((0, _mathjs.evaluate)("".concat(value, " - ").concat(UT)), {
          precision: 14
        }));
        TD = "".concat(inspection.greaterThan).concat(td);
      } else if (value < LT) {
        var _td = Number((0, _mathjs.format)((0, _mathjs.evaluate)("".concat(LT, " + ").concat(value)), {
          precision: 14
        }));
  ...
  var commonInputPressEnter = function commonInputPressEnter(e, record, fieldName, index) {
    ...
    if (typeof value === 'null' && !fieldParams[0].meta.ALLOWNULL) {
      _antd.message.warning("".concat(inspection.parameterEmpty));
  ...
  var onInputBlur = function onInputBlur(fieldName, index) {
    ...
    if (oldValue !== newValue && oldValue !== null) {
      _antd.message.warning("".concat(inspection.notSaved));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              _antd.message.warn("".concat(inspection.selectData));
  ...
  var saveFooter = (0, _utils2.debounce)( /*#__PURE__*/function () {
  ...
  var loopNode = function loopNode() {
    ...
    return data.map(function (item) {
      ...
      var title = /*#__PURE__*/_react.default.createElement("span", null, _utils2.isEnglish ? ENNAME || FIELDNAME : NAME);
  ...
  var content = /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Tree, {
    checkable: true,
    onCheck: onCheck,
    checkedKeys: checkedKeys
  }, loopNode((0, _utils2.parseMeta)(body)))); // 缺陷表单
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, /*#__PURE__*/_react.default.createElement(_InspectionHeader.default, {
    data: data,
    header: header,
    hData: newRowData || hData,
  ...
  }, inspection.clearAll), /*#__PURE__*/_react.default.createElement(_antd.Button, {
    type: "primary",
    onClick: clearSingleCatch,
    disabled: formDisabled || currentInspection === null
  }, inspection.removeSingle), showFooter && footer.length > 0 ? /*#__PURE__*/_react.default.createElement(_antd.Button, {
    type: "primary",
    onClick: clickDefectForm // disabled={formDisabled || currentInspection === null}

  }, defectForm) : '', /*#__PURE__*/_react.default.createElement(_antd.Button, {
    type: "primary",
    onClick: showFooter ? clickDefectForm : completeSave,
    disabled: formDisabled
  }, inspection.entryComplete), /*#__PURE__*/_react.default.createElement(_antd.Switch, {
    ...
    type: "primary"
  }, " \u9009\u62E9\u5C55\u793A\u5217"))), /*#__PURE__*/_react.default.createElement("div", {
    className: currentInspectionResult && currentInspectionResult.TR === 'NG' ? "insp-result ng" : "insp-result"
  }, currentInspectionResult && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("span", null, inspection.testValue, ": ", currentInspectionResult.TV), /*#__PURE__*/_react.default.createElement("span", null, inspection.conclusion, ": ", currentInspectionResult.TR), /*#__PURE__*/_react.default.createElement("span", null, inspection.conclusionDescription, ": ", currentInspectionResult.TD)))), /*#__PURE__*/_react.default.createElement(_antd.Form, {
    form: form,
    name: "inspectionForm"
  ...
  }, /*#__PURE__*/_react.default.createElement(_userSelectForm.default, {
    ref: childRef,
    onOk: selectOk,
    editor: editor
  })), /*#__PURE__*/_react.default.createElement(_DragModal.default, {
    ...
    }, inspection.cancel), /*#__PURE__*/_react.default.createElement(_antd.Button, {
      type: "primary",
      ghost: true,
      onClick: onFooterFormChange
    }, inspection.ts), /*#__PURE__*/_react.default.createElement(_antd.Button, {
      type: "primary",
      onClick: completeSave
    }, inspection.submit)]
  }, /*#__PURE__*/_react.default.createElement(_PropertyForm.default, _extends({
    ref: defectRef
...
var _default = (0, _dva.connect)(mapStateToProps)(EnterCmp);
