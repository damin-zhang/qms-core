...
exports.customPage = exports.configPlatform = exports.commonNavigationList = void 0;
...
var commonNavigation = _language.default.commonNavigation,
    ...
    staffManage = _language.default.userManage.staffManage,
    _language$activiti = _language.default.activiti,
    ...
    _language$qualityGate = _language.default.qualityGate,
    ...
    viewFields = _language.default.viewFields,
    JsScriptFields = _language.default.JsScriptFields,
    dataDictionary = _language.default.dataDictionary;
var customPage = [{
  NO: 'tableConfig',
...
exports.commonNavigationList = commonNavigationList;
var configPlatform = [// 配置平台
{
  CAPTION: title,
  NO: 'ConfigPlatform',
  ID: 'config',
...
exports.configPlatform = configPlatform;