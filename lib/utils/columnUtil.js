...
exports.setOldColumns = exports.setMultipleColumns = exports.setInspectionColumns = exports.setColumns = exports.setColumn = exports.setAntdColumns = void 0;
...
var fixed_column = _language.default.table.fixed_column;
...
var clickLink = function clickLink(linkParams, text, objectANamespace, record, fieldName, showSubPage) {
  ...
  if (linkType === 1) {
    ...
    URL = fields ? (0, _utils.replaceLinkSql)(record, URL) : URL;
    window.open(URL);
  } else if (linkType === 4) {
    showSubPage([record]);
  } else {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _uploadApi.uploadRjFile)({
              file: file,
      ...
      render: function render(text, record, index) {
        ...
        if (gType === 2) {
          try {
            ...
            return color ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
              color: color
            }, value) : value;
          } catch (err) {
            console.log(err);
          ...
          if (editor === 'MapValueList' || editor === 'ValueList' || editor === 'RadioEditor' || editor === 'CheckEditor') {
            ...
            if (num !== -1) {
              ...
              Cmp = _color ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
                color: _color
              }, _name) : _name;
            } else {
              Cmp = text;
            ...
            Cmp = /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
              title: text,
              placement: "topLeft",
    ...
    return {
      ...
      headerRenderer: function headerRenderer() {
        return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
          title: fixed_column
        }, /*#__PURE__*/_react.default.createElement(Icon.LockOutlined, {
        ...
        if (gType === 2) {
          ...
          if (editor === 'MapValueList' || editor === 'ValueList' || editor === 'RadioEditor' || editor === 'CheckEditor') {
            ...
            if (num !== -1) {
              ...
              Cmp = _color2 ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
                color: _color2
              }, _name2) : _name2;
            } else {
              Cmp = text;
            ...
            Cmp = /*#__PURE__*/_react.default.createElement("span", {
              style: {
                maxWidth: '100%',
                overflow: 'hidden',
                textOverflow: 'ellipsis'
...
var setAntdColumns = function setAntdColumns() {
  var columns = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var namespace = arguments.length > 1 ? arguments[1] : undefined;
    ...
    return {
      title: function title() {
        return /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
          title: _utils.isEnglish ? isModeling ? "".concat(fieldName, ":").concat(enName) : enName : caption ? isModeling ? "".concat(fieldName, "\uFF1A").concat(caption) : caption : isModeling ? "".concat(fieldName, "\uFF1A").concat(name) : name
        }, /*#__PURE__*/_react.default.createElement("span", {
          style: {
            display: 'block',
            maxWidth: '100%',
        ...
        }, caption || _utils.isEnglish ? enName : name));
      },
        ...
        if (gType === 2) {
          ...
          if (editor === 'MapValueList' || editor === 'ValueList' || editor === 'RadioEditor' || editor === 'CheckEditor') {
            ...
            if (num !== -1) {
              ...
              Cmp = _color3 ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
                color: _color3
...
exports.setAntdColumns = setAntdColumns;
...
var getDataStateCmp = function getDataStateCmp(text, record, icon, newIcon, IconView, supLink) {
  ...
  return record.STATE ? /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
    title: newText,
    placement: "topLeft",
    destroyTooltipOnHide: true
  }, /*#__PURE__*/_react.default.createElement("span", {
  ...
  }, text)) : /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
    title: newText,
    placement: "topLeft",
    destroyTooltipOnHide: true
  }, /*#__PURE__*/_react.default.createElement("span", {
...
var setOldColumns = function setOldColumns(columns) {
  return columns.map(function (item) {
...
exports.setOldColumns = setOldColumns;

var setInspectionColumns = function setInspectionColumns(_ref6) {
  ...
  var columns = tableHead.map(function (item, index) {
    return _objectSpread(_objectSpread({
      ...
      render: item.render ? item.render : item.input ? function (text, record, i) {
        ...
        return item.dataIndex === 'TR' ? /*#__PURE__*/_react.default.createElement(_antd.Form.Item, {
          ...
          value: "NG",
          className: TRClass
        }, "NG"))) : item.dataIndex === 'DEFECT_TYPE' ? /*#__PURE__*/_react.default.createElement(_antd.Form.Item, {
          name: [record.InspectionItem.ID, 'InspectionItem', item.dataIndex],
          key: record.InspectionItem.ID
        }, /*#__PURE__*/_react.default.createElement(_antd.Select, {
          showSearch: true,
        ...
        }, "\u7F3A\u9677\u4EE3\u7801")), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
          title: "\u7F3A\u9677\u7C7B\u578B"
        }, /*#__PURE__*/_react.default.createElement("div", {
          className: "selectOptionObject"
        }, "\u7F3A\u9677\u7C7B\u578B")), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
          title: "\u7F3A\u9677\u503C"
        }, /*#__PURE__*/_react.default.createElement("div", {
          className: "selectOptionObject"
        }, "\u7F3A\u9677\u503C")), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
          title: "\u7F3A\u9677\u63CF\u8FF0"
        }, /*#__PURE__*/_react.default.createElement("div", {
          className: "selectOptionObject"
          ...
          return /*#__PURE__*/_react.default.createElement(_antd.Select.Option, {
            ...
            className: "selectOptionObject"
          }, item.DEFECT_CODE)), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
            title: item.DEFECT_TYPE
          }, /*#__PURE__*/_react.default.createElement("div", {
            className: "selectOptionObject"
          }, item.DEFECT_TYPE)), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
            title: item.DEFECT_VALUE
          }, /*#__PURE__*/_react.default.createElement("div", {
            className: "selectOptionObject"
          }, item.DEFECT_VALUE)), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
            title: item.DEFECT_DESCRIPTION
          }, /*#__PURE__*/_react.default.createElement("div", {
            className: "selectOptionObject"
          }, item.DEFECT_DESCRIPTION))));
        }))) : item.dataIndex === 'REMARK' ? /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
        ...
        }))) : item.dataIndex === 'file' ? /*#__PURE__*/_react.default.createElement(_antd.Upload, {
        ...
        }, "\u4E0A\u4F20\u9644\u4EF6")) : /*#__PURE__*/_react.default.createElement(_antd.Form.Item, {
          name: [record.InspectionItem.ID, 'InspectionItem', item.dataIndex],
          key: record.InspectionItem.ID
  ...
  var _loop = function _loop(i) {
    columns.push({
      ...
      render: function render(text, record, index) {
        ...
        return record.InspectionItem.SQ > i && (USL || LSL ? !isNaN(Number(USL)) || !isNaN(Number(LSL)) : false) ? /*#__PURE__*/_react.default.createElement(_antd.Form.Item, {
  ...
  var columns2 = tableHead2.map(function (item, index) {
    return _objectSpread(_objectSpread({
      ...
      render: item.render ? item.render : item.input ? function (text, record, i) {
        ...
        if (initValue === 'OK') TRClass += " ok";
        if (initValue === 'NG') TRClass += " ng";
        return item.dataIndex === 'DEFECT_TYPE' ? /*#__PURE__*/_react.default.createElement(_antd.Form.Item, {
          name: [record.InspectionItem.ID, 'InspectionItem', item.dataIndex],
          key: record.InspectionItem.ID
        }, /*#__PURE__*/_react.default.createElement(_antd.Select, {
          showSearch: true,
        ...
        }))) : item.dataIndex === 'DEFECT_DESCRIPTION' ? /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
...
var setMultipleColumns = function setMultipleColumns() {
  var columns = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var namespace = arguments.length > 1 ? arguments[1] : undefined;
  var model = arguments.length > 2 ? arguments[2] : undefined;
  var lockColumns = arguments.length > 3 ? arguments[3] : undefined;
  ...
  var gridFiledList = (0, _utils.ergodicRoot)(columns.map(function (item) {
    item.pId = item.pId || '0';
    return item;
  }), '0', 'pId', 'id');
    ...
    var columns = gridFiledList.map(function (item) {
      ...
      if (gType && gType === 4) {
        columnItem.title = function () {
          return /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
            title: caption || _utils.isEnglish ? enName || fieldName : name
          }, /*#__PURE__*/_react.default.createElement("div", {
            style: {
              maxWidth: '100%',
              height: '100%',
          ...
          }, caption || _utils.isEnglish ? enName || fieldName : name));
        };
...
exports.setMultipleColumns = setMultipleColumns;
...
var gridColumnItem = function gridColumnItem(item, namespace, model, isTree, showSubPage) {
  ...
  return {
    title: function title() {
      return /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
        title: _utils.isEnglish ? isModeling ? "".concat(fieldName, ":").concat(enName) : enName || fieldName : caption ? isModeling ? "".concat(fieldName, "\uFF1A").concat(caption) : caption : isModeling ? "".concat(fieldName, "\uFF1A").concat(name) : name
      }, /*#__PURE__*/_react.default.createElement("span", {
        style: {
          display: 'block',
          maxWidth: '100%',
      ...
      if (gType === 2) {
        ...
        if (editor === 'MapValueList' || editor === 'ValueList' || editor === 'RadioEditor' || editor === 'CheckEditor') {
          ...
          if (num !== -1) {
            ...
            Cmp = _color4 ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
              color: _color4
            }, icon && newIcon ? /*#__PURE__*/_react.default.createElement(_reactSvg.ReactSVG, {
              style: {
                fill: '#fff'
