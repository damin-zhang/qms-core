...
var styleMap = [{
  unChecked: _utils.isEnglish ? 'Collapse' : '收起',
  checked: _utils.isEnglish ? 'Top' : '置顶',
  name: 'position'
}, {
  unChecked: _utils.isEnglish ? 'Dark' : '暗黑',
  checked: _utils.isEnglish ? 'Light' : '明亮',
  name: 'theme'
}, {
  unChecked: _utils.isEnglish ? 'Inline' : '内嵌',
  checked: _utils.isEnglish ? 'Vertical' : '垂直',
  name: 'mode'
}, // { unChecked: isEnglish ? 'Expand' : '展开', checked: isEnglish ? 'Collapsed' : '缩起', name: 'collapsed' },
{
  unChecked: _utils.isEnglish ? 'Discard' : '丢弃',
  checked: _utils.isEnglish ? 'Collect' : '收藏',
  name: 'collect'
}];
  ...
  var getMenus = function getMenus(data, commonNavigations) {
    return data.map(function (item) {
      ...
      _react.default.createElement(_reactSvg.ReactSVG, {
        ...
        src: svgDir("./".concat(newIcon, ".svg"))
      }) : IconView && /*#__PURE__*/_react.default.createElement(IconView, null) || /*#__PURE__*/_react.default.createElement(Icon.BorderOuterOutlined, null)), /*#__PURE__*/_react.default.createElement("span", null, CAPTION !== undefined ? CAPTION : _utils.isEnglish ? META.ENNAME || META.NO : META.NAME)); // 是否开启建模
