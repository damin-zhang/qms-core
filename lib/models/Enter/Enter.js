...
var _default = {
  ...
  reducers: {
    packet: function packet(state, _ref) {
      ...
      if (payload.formData) {
        payload.formData.forEach(function (item) {
          formInitValue[item.InspectionItem.ID] = item;
        });
      }
    ...
    initPacket: function initPacket(state, _ref2) {
      var _ref2$payload = _ref2.payload,
          ...
          defectCode = _ref2$payload.defectCode;
      var formInitValue = {};
    ...
    setFormData: function setFormData(state, _ref3) {
      var formData = _ref3.payload.formData;
      var formInitValue = {};
  ...
  effects: {
    clearAllCatch: /*#__PURE__*/_regeneratorRuntime().mark(function clearAllCatch(_ref4, _ref5) {
      var payload, call, put, data;
      return _regeneratorRuntime().wrap(function clearAllCatch$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return call(_applicationApi.commonApi, payload);
    ...
    clearSingleCatch: /*#__PURE__*/_regeneratorRuntime().mark(function clearSingleCatch(_ref6, _ref7) {
      var _ref6$payload, values, formData, ID, call, put, data, newFormData;

      return _regeneratorRuntime().wrap(function clearSingleCatch$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _ref6$payload = _ref6.payload, values = _ref6$payload.values, formData = _ref6$payload.formData, ID = _ref6$payload.ID;
            ...
            case 4:
              ...
              newFormData = formData.map(function (item) {
                if (item.InspectionItem.ID === ID) return data.dataList[0];
                return item;
              });
              _context2.next = 9;
              return put({
                type: 'packet',
                payload: {
                  dataList: _toConsumableArray(newFormData),
                  formData: _toConsumableArray(newFormData)
                }
              });
