...
var _language$configPlatf = _language.default.configPlatform,
    ...
    roleUser = _language.default.userManage.roleManage.roleUser,
    JsScriptFields = _language.default.JsScriptFields;
...
var paramsMap = {
  ...
  script: {
    queryAPI: _metaApi.getMetaScriptData,
    searchApi: _metaApi.getMetaScriptData,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 23:
              ...
              }), (0, _queryTabConfigRelationApi.queryRelationPropertyQueryApi)(tn, objectTypes));
            ...
            case 26:
              ...
              dataList = (0, _utils.parseMeta)(dataList);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return call(_metaApi.queryMetaAuthcode);
          ...
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return call(_applicationApi.commonApi, {
                implclass: _mapParams.implclassMap.searchSingleData,
                queryWord: queryWord,
                objectNo: 'AUTHCODE'
              });
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 4;
              return call(_api.queryProceduresParams, name);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 5:
              data = _context7.sent;
              _context7.next = 8;
              return call(_queryDataApi.commonSingleQuery, {
                page: current,
                pageSize: pageSize,
                tableName: tableName,
                objectGridNo: objectGridNo,
            ...
            case 8:
              ...
              return put({
                type: 'packet',
                payload: {
                  columns: (0, _columnUtil.setAntdColumns)(data.gridFieldList, 'selectData', {
                    total: data2.total,
                    page: current,
                    pageNumber: pageSize,
                    pageSize: pageSize
