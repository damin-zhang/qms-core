...
var _default = {
  ...
  effects: {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return call(commonService.get, '/act/process/getProcdefProcess');
    ...
    startProcess: /*#__PURE__*/_regeneratorRuntime().mark(function startProcess(_ref5, _ref6) {
      var _ref5$payload, id, selectedRows, call, put, queryParam, _yield$call, data;
  ...
  subscriptions: {
    setup: function setup(_ref7) {
      ...
      history.listen(function (location) {
        ...
        var id = path.substr(index);

        switch (location.pathname) {
          case "/act/startProcess".concat(id):
            dispatch({
              type: 'query',
              payload: {}
            });
