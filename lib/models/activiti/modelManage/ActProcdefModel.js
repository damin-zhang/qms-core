        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return call(_processApi.getProcdefProcess, {
                page: page ? page : 1,
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              values.id = record.ID;
              _context3.next = 6;
              return call(_processApi.processUpdate, _objectSpread({}, values));
            ...
            case 9:
              ...
              _context3.next = 12;
              return call(_processApi.processBind, _objectSpread({}, values));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 4;
              return call(_processApi.processState, {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 4;
              return call(_processApi.processDelete, {
                id: selectedRows1[0].ID
              });
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 5;
              return call(_queryDataApi.commonSingleQuery, noticeValues);
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 4;
              return call(_processApi.activationProcess, {
                id: id
              });
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 4;
              return call(_processApi.searchProcdefProcess, {
                keyWord: keyWord,
                page: page,
                pageSize: pageSize
              });
