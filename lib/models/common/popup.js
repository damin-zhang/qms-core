...
var _PopupEngine = _interopRequireDefault(require("../../component/engine/PopupEngine"));

var _SubPageEngine = _interopRequireDefault(require("../../component/engine/SubPageEngine"));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              caption = caption ? caption : _utils.isEnglish ? enName : name;
              _context.next = 7;
            ...
            case 17:
              ...
              config = JSON.parse(_jsBase.Base64.decode(data.dataList));
              ...
              ModalPage = (0, _PopupEngine.default)({
                caption: caption,
                wType: wType,
                menuId: id,
                namespace: namespace,
              ...
              return put({
                type: "tab/addModal",
                payload: {
                  Cmp: /*#__PURE__*/_react.default.createElement(ModalPage, {
                    key: id
                  }),
                  key: id
                }
            ...
            case 37:
              ...
              _ModalPage = (0, _PopupEngine.default)({
                caption: caption,
                wType: wType,
                menuId: id,
                namespace: namespace,
              ...
              return put({
                type: "tab/addModal",
                payload: {
                  Cmp: /*#__PURE__*/_react.default.createElement(_ModalPage, {
                    key: id
                  }),
                  key: id
                }
            ...
            case 46:
              ...
              _hData = values.hData;
              _context.next = 50;
              return call(_metaApi.queryRelationModel, {
            ...
            case 56:
              _antd.message.info(_data2.hint);
            ...
            case 68:
              _context.next = 70;
              return call(_metaApi.queryPropertyModel, {
            ...
            case 78:
              ...
              _context.next = 85;
              return call(_applicationApi.queryEditorData, {
                tableName: _objectNo || tableName,
            ...
            case 94:
              ...
              _context.next = 99;
              return call(_metaApi.queryGridModel, {
            ...
            case 102:
              ...
              (0, _utils.judgeModel)(namespace);
              _context.next = 107;
              return call(_metaApi.querySingleModel, {
                objectNo: _objectNo,
                facetype: 1
              });
            ...
            case 109:
              (0, _utils.judgeModel)(namespace); // modelData = modelData

              return _context.abrupt("break", 124);

            case 111:
              namespace = params.templateNo;
              (0, _utils.judgeModel)(namespace); // 质检录入弹窗建模数据请求

              _context.next = 115;
              return call(_metaApi.getTemplateMetaData, {
            ...
            case 117:
              namespace = params.templateNo;
              (0, _utils.judgeModel)(namespace); // 质检报告弹窗建模数据请求
            ...
            case 124:
              _ModalPage2 = (0, _PopupEngine.default)(_objectSpread(_objectSpread({
                caption: caption
              }, modelData), {}, {
                wType: wType,
                menuId: id,
              ...
              return put({
                type: "tab/addModal",
                payload: {
                  Cmp: /*#__PURE__*/_react.default.createElement(_ModalPage2, {
                    key: id
                  }),
                  key: id
                }
            ...
            case 172:
              ...
              _context.next = 177;
              return call(_applicationApi.commonApi, reqParams);
            ...
            case 177:
              ...
              _context.next = 186;
              return call(_uploadApi.getImgFileData, {
                id: _hData7[0].ID,
                objectNo: objectNo,
                data: imgJson
              });
                ...
                return _regeneratorRuntime().wrap(function _loop$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 9:
                        // const namespace = id
                        if (rType !== 'relationproperty') (0, _utils.judgeModel)(namespace);
                      ...
                      case 35:
                        Cmp = (0, _SubPageEngine.default)(modalData);
