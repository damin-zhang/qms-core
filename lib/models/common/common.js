...
var _developApi = require("../../service/developApi");
...
var fields = _language.default.activiti.Process_instance.fields;
var _default = {
  namespace: 'common',
  state: {},
  effects: {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return call(_uploadApi.downloadFiles, values);
            ...
            case 11:
              ...
              _context.next = 14;
              return call(_developApi.develop, _objectSpread({
                path: values.path
              }, values));
            ...
            case 35:
              _antd.message.info(fields.noProcess, 3);
            ...
            case 38:
              _antd.message.info(hint); // 操作成功，执行回调函数关闭弹窗
            ...
            case 68:
              _context.next = 70;
              return call(_communicationApi.taskTodo, {
                status: 0
              });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              _context2.next = 10;
              return call(isTree ? _metaApi.moveMenu : _metaApi.moveRow, {
                hData: newList,
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 7;
              return call(_systemApi.systemAuthcodeQuery, {
                page: page,
                pageSize: pageSize,
                tableName: 'AUTHCODE'
              });
            ...
            case 10:
              _context3.next = 12;
              return call(_queryDataApi.commonSingleQuery, _objectSpread({
                page: page,
                pageSize: pageSize,
                tableName: tableName
              }, params));
            ...
            case 13:
              ...
              return put({
                ...
                payload: {
                  ...
                  implClass: _mapParams.implclassMap.querySingleData,
                  queryName: 'common/querySingleData',
                  queryApi: tableName === 'AUTHCODE' ? _systemApi.systemAuthcodeQuery : _queryDataApi.commonSingleQuery,
                  namespace: namespace,
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 4;
              return call(_applicationApi.commonApi, _objectSpread({
                page: page
              }, rest));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 6;
              return call(_queryDataApi.queryRelationViewSubPageModel, {
                page: page,
                pageSize: pageSize,
                tableName: objectNo,
            ...
            case 9:
              ...
              _context5.next = 12;
              return call(_queryDataApi.queryInputData, {
                jsonData: objectAData,
                page: page,
                pageSize: pageSize
              });
            ...
            case 15:
              ...
              _context5.next = 18;
              return call(_queryDataApi.queryOutputData, {
                jsonData: objectAData,
                page: page,
                pageSize: pageSize
              });
            ...
            case 21:
              ...
              _context5.next = 24;
              return call(_queryDataApi.queryProcessDetailData, {
                jsonData: objectAData,
                tableName: objectNo,
                objectA: objectA
              });
            ...
            case 27:
              _context5.next = 29;
              return call(_queryDataApi.querySubPageModel, {
                page: page,
                pageSize: pageSize,
                objectB: objectNo,
            ...
            case 30:
              ...
              return put({
                ...
                payload: {
                  ...
                  queryApi: _queryDataApi.querySubPageModel,
                  queryParams: {
                    objectB: objectNo,
                    relationObject: relationObject,
                    objectA: objectA,
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 4;
              return call(_queryDataApi.commonSingleQueryNoPaging, _objectSpread(_objectSpread({}, rest), {}, {
                implclass: _mapParams.implclassMap.queryClassNodeData,
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 4;
              return call(_queryDataApi.queryClassObjectData, _objectSpread({
                page: page,
                pageSize: pageSize,
                implclass: _mapParams.implclassMap.queryClassObjectData,
            ...
            case 4:
              ...
              return put({
                ...
                payload: {
                  ...
                  queryApi: _queryDataApi.queryClassObjectData
                }
              });
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 4;
              return call(_queryDataApi.queryAutoClassObjectData, _objectSpread({
                page: page,
                implclass: objectA ? _mapParams.implclassMap.queryRelationAutoClassData : _mapParams.implclassMap.queryAutoClassData
              }, rest));
            ...
            case 4:
              ...
              return put({
                ...
                payload: {
                  ...
                  queryApi: _queryDataApi.commonSingleQuery,
                  queryParams: _objectSpread({
                    tableName: objectNo,
                    objectNo: objectNo
                  }, rest)
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 4;
              return call(_queryDataApi.queryCalendarViewAllData, _objectSpread({}, rest));
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.next = 4;
              return call(_queryDataApi.commonLikeQuery, _objectSpread(_objectSpread({
                page: page,
                pageSize: pageSize
              }, rest), {}, {
                implclass: _mapParams.implclassMap.advancedSearch,
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              _context13.next = 4;
              return call(_applicationApi.commonApi, _objectSpread({
                implclass: _mapParams.implclassMap.moveNode,
                data: data,
                hData: hData
              }, rest));
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              _context14.next = 4;
              return call(_applicationApi.commonApi, _objectSpread({
                implclass: _mapParams.implclassMap.moveNodeData,
                hData: hData
              }, rest));
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            case 0:
              ...
              _context15.next = 4;
              return call(_metaApi.refreshAutoClassTree, _objectSpread({}, rest));
        ...
        while (1) {
          switch (_context16.prev = _context16.next) {
            case 0:
              ...
              _context16.next = 5;
              return call(_applicationApi.queryMenuEnable, _objectSpread({
                implclass: _mapParams.implclassMap.queryContextMenu
              }, rest));
