...
var _ActEndProcessCmp = _interopRequireDefault(require("../../../component/activiti/processManage/ActEndProcessCmp"));
...
var ActEndProcess = function ActEndProcess(_ref) {
  var dispatch = _ref.dispatch,
      EndProcess = _ref.EndProcess;
  var _EndProcess$list = EndProcess.list,
      list = _EndProcess$list === void 0 ? [] : _EndProcess$list,
      total = EndProcess.total,
      page = EndProcess.page,
      pageNumber = EndProcess.pageNumber,
      visibleEndPro = EndProcess.visibleEndPro;
  ...
  var columns = [{
    ...
    render: function render(text, record) {
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
      ...
      }, buttons.schedule), /*#__PURE__*/_react.default.createElement(_antd.Button, {
        style: {
          marginLeft: '5px'
        },
        type: "primary",
        ...
        onClick: function onClick() {
          return (0, _utils.showConfirm)(function () {
            return deleteProcess(record.processInstanceId);
          });
        }
      }, buttons.delete));
    }
  ...
  var closeEndPro = function closeEndPro() {
    dispatch({
      type: 'EndProcess/packet',
      payload: {
        visibleEndPro: !visibleEndPro
      }
    });
  }; //打开详情页面模态框
  ...
  var deleteProcess = function deleteProcess(processInstanceId) {
    dispatch({
      type: 'EndProcess/deleteProcess',
      payload: {
        processInstanceId: processInstanceId
      }
    });
  ...
  var changePage = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, pageSize) {
      var state, api, userName, searchWord;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              state = false;
              api = keyWord ? _processApi.processGetEndProcessSearch : _processApi.processGetEndProcess;
  ...
  var props = {
    ...
    paging: paging,
    visibleEndPro: visibleEndPro,
    closeEndPro: closeEndPro,
    onSearch: onSearch
  };
  return /*#__PURE__*/_react.default.createElement(_ActEndProcessCmp.default, props);
};

function mapStateToProps(_ref4) {
  var EndProcess = _ref4.EndProcess;
  return {
    EndProcess: EndProcess
  };
}

var _default = (0, _dva.connect)(mapStateToProps)(ActEndProcess);
