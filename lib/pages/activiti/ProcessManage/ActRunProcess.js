...
var _ActRunProcessCmp = _interopRequireDefault(require("../../../component/activiti/processManage/ActRunProcessCmp"));
...
var ActRunProcess = function ActRunProcess(_ref) {
  ...
  list = (0, _utils.generatorTableKey)(list); //打开进展流程图模态框
  ...
  var showOpinion = function showOpinion(processInstanceId) {
    ...
    var title = _utils.isEnglish ? 'cancellationCause' : '作废原因'; //后端请求路径
  ...
  return /*#__PURE__*/_react.default.createElement(_ActRunProcessCmp.default, props);
};
...
var _default = (0, _dva.connect)(mapStateToProps)(ActRunProcess);
