...
var _ProcessActinstCmp = _interopRequireDefault(require("../../../component/activiti/activitiCommon/ProcessActinstCmp"));
...
var ProcessActinst = function ProcessActinst(_ref) {
  ...
  processReverseList = (0, _utils.generatorTableKeyByIndex)(processReverseList); //关闭模态框
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_ProcessActinstCmp.default, props), /*#__PURE__*/_react.default.createElement(_ProcessOpinion.default, {
    list: list
  }));
};
...
var _default = (0, _dva.connect)(mapStateToProps)(ProcessActinst);
