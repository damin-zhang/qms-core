...
var TabsTable = function TabsTable(_ref) {
  ...
  var tabsOnchange = function tabsOnchange(activeKey) {
    ...
    switch (activeKey) {
      ...
      case '2':
        ...
        showObject('state IN(0,2)', 'workObject');
        break;

      case '3':
        setObjectType('commonObject');
        sessionStorage['tableConfigObjectType'] = 'commonObject';
        showObject('sobject=1');
        break;
  ...
  }, /*#__PURE__*/_react.default.createElement(Cmp, tableProps)));
};

var _default = TabsTable;
