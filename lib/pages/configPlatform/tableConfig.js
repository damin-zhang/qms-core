...
var _TableConfigCmp = _interopRequireDefault(require("../../component/configPlatform/tableConfig/TableConfigCmp"));
...
var TableConfig = function TableConfig(_ref) {
  ...
  // },
  {
    ...
    width: 100,
    render: function render(text) {
      return text || text === 0 ? /*#__PURE__*/_react.default.createElement(_antd.Tag, {
        color: _mapParams.colorMap[text]
      }, _utils.isEnglish ? _EnMapParams.objTypeMap[text] : _mapParams.objTypeMap[text]) : _utils.isEnglish ? _EnMapParams.objTypeMap[text] : _mapParams.objTypeMap[text];
    }
  }, {
  ...
  }, buttons.update)), STATE === 0 && /*#__PURE__*/_react.default.createElement(_antd.Menu.Item, null, /*#__PURE__*/_react.default.createElement("a", {
  ...
  }, buttons.delete)), STATE === 1 && /*#__PURE__*/_react.default.createElement(_antd.Menu.Item, null, /*#__PURE__*/_react.default.createElement("a", {
  ...
  }, buttons.refresh_meta)), TYPE !== 4 && STATE === 1 && /*#__PURE__*/_react.default.createElement(_antd.Menu.Item, null, /*#__PURE__*/_react.default.createElement("a", {
  ...
  }, buttons.copy_obj)), TYPE !== 4 && STATE === 1 && /*#__PURE__*/_react.default.createElement(_antd.Menu.Item, null, /*#__PURE__*/_react.default.createElement("a", {
  ...
  }, buttons.copy_view)), enable && TYPE === 0 && /*#__PURE__*/_react.default.createElement(_antd.Menu.Item, null, /*#__PURE__*/_react.default.createElement("a", {
    ...
    dispatch({
      ...
      payload: {
        record: _objectSpread(_objectSpread({}, record), {}, {
          ...
          IMPLCLASS: IMPLCLASS || _mapParams.objImplclassMap[TYPE],
          CONTROLAUTH: false
        }),
        visible: !visible,
        noFooter: noFooter
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (isSearch) {
                ...
                state = objectType === 'workObject' ? _metaApi.searchWorkObject : (0, _metaApi.searchObject)({
                  tn: 1,
                  paging: true,
                  page: current,
                  pageSize: pageSize,
                ...
                state = objectType === 'workObject' ? _metaApi.queryWorkObject : (0, _metaApi.queryObject)({
                  tn: 1,
                  paging: true,
                  page: current,
                  pageSize: pageSize
  ...
  var tabsProps = [{
    caption: _utils.isEnglish ? 'Business Objects' : '业务对象',
    key: '1'
  }, {
    caption: _utils.isEnglish ? 'Objects In Design' : '设计中对象',
    key: '2',
    disabled: !isModeling
  }, {
    caption: _utils.isEnglish ? 'System Objects' : '系统对象',
    key: '3',
    disabled: !isModeling
  }];
  var tabsTableProps = {
...
var _default = (0, _dva.connect)(mapStateToProps)(TableConfig);
