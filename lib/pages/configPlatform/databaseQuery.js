...
var close = _language.default.common.close,
    _language$configPlatf = _language.default.configPlatform.databaseQuery,
    querySql = _language$configPlatf.querySql,
    queryQms = _language$configPlatf.queryQms,
    querySpc = _language$configPlatf.querySpc,
    title = _language$configPlatf.title,
    result = _language$configPlatf.result;
...
var Index = function Index() {
            ...
            case 0:
              ...
              return (0, _api.dbQuery)({
                ...
                if (data === undefined || !data.flag) {
                  ...
                  var _fieldList2 = data.fieldList,
                      _dataList2 = data.dataList,
                      hint = data.hint;
                  setModelData({
                    fieldList: _fieldList2,
                    dataList: _dataList2,
                    hint: hint
                  });
                  setPage(page);
  ...
  var fieldList = modelData.fieldList,
  ...
  }, queryQms)), info && /*#__PURE__*/_react.default.createElement(_antd.Typography.Text, null, result, "\uFF1A", info), fieldList && dataList && /*#__PURE__*/_react.default.createElement("div", {
    className: "flex-grow-y"
  }, /*#__PURE__*/_react.default.createElement(_ParseTable.default, {
    rowSelection: {
      type: 'radio',
      selectedRowKeys: rows[0] ? [rows[0].ID] : [],
      onChange: function onChange(keys, rows) {
        setRows(rows);
        setVisible(true);
      }
    },
    columns: fieldList.map(function (item) {
      return {
        title: item,
        dataIndex: item,
        width: 100
  ...
  }, fieldList && /*#__PURE__*/_react.default.createElement(_antd.Form, _extends({
    name: title,
    layout: "inline",
    initialValues: rows[0]
  }, layout), fieldList.map(function (item, index) {
