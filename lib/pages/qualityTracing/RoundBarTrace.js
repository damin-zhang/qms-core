...
var RoundBarTrace = function RoundBarTrace() {
  ...
  var _useState15 = (0, _react.useState)([]),
      ...
      shortRodPicoNoFields = _useState16[0],
      setShortRodPicoNoFields = _useState16[1];
  ...
  (0, _react.useEffect)(function () {
    ...
    (0, _traceApi.shortRodSearchFields)().then(function (data) {
      if (data) {
        var _shortRodPicoNoFields = [];
        _shortRodPicoNoFields = data.shortRodPicoNoFields && data.shortRodPicoNoFields.filter(function (item) {
          return item !== null && item;
        });
        setShortRodPicoNoFields(_shortRodPicoNoFields);
      }
    });
  }, []);
  var columns = [].concat(_toConsumableArray(_TableColumns.roundBarTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 60,
    ...
    render: function render(record) {
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
        ...
        onClick: function onClick() {
          (0, _utils.toGFTrackPage)(record, 'dyb');
        }
      }, "\u8FFD\u6EAF"));
    }
  }]);
  ...
  var onFinish = function onFinish(values) {
    setLoading(true);
    (0, _traceApi.shortRodQuery)(_objectSpread({
      page: page,
      pageSize: pageSize
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return (0, _traceApi.shortRodQuery)(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  }, "\u77ED\u5706\u68D2\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/_react.default.createElement(_antd.Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u77ED\u5706\u68D2\u6279\u6B21\u53F7"), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
    title: tipTitleP
  ...
  }, shortRodPicoNoFields && shortRodPicoNoFields.map(function (item, index) {
