...
var RoundBarTrace = function RoundBarTrace(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    (0, _traceApi.cutRoundBarDetailsQuery)().then(function (data) {
      if (data) {
  ...
  var columns = [].concat(_toConsumableArray(_TableColumns.cutRoundBarTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 120,
    ...
    render: function render(record) {
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
        ...
        onClick: function onClick() {
          (0, _utils.toGFTrackPage)(record, 'fjdyb');
        }
  ...
  var onFinish = function onFinish(values) {
    ...
    (0, _traceApi.reverseTruncatedRoundBarQuery)(_objectSpread({
      page: page,
      pageSize: pageSize
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return (0, _traceApi.reverseTruncatedRoundBarQuery)(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  }, "\u53CD\u622A\u77ED\u5706\u68D2\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/_react.default.createElement(_antd.Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/_react.default.createElement("div", {
...
var _default = (0, _dva.connect)(mapStateToProps)(RoundBarTrace);
