...
var SketchyBarTrace = function SketchyBarTrace(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    (0, _traceApi.hairStickFields)().then(function (data) {
      if (data) {
  ...
  var columns = [].concat(_toConsumableArray(_TableColumns.sketchyBarTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 120,
    ...
    render: function render(record) {
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
        ...
        onClick: function onClick() {
          (0, _utils.toGFTrackPage)(record, 'mb');
        }
  ...
  var onFinish = function onFinish(values) {
    ...
    if (values.OUTTIME) {
      values.STARTTIME = (0, _moment.default)(values.OUTTIME[0]).format(dateFormat);
      values.ENDTIME = (0, _moment.default)(values.OUTTIME[1]).format(dateFormat);
      delete values.OUTTIME;
    }

    (0, _traceApi.hairStickQuery)(_objectSpread({
      page: page,
      pageSize: pageSize
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return (0, _traceApi.hairStickQuery)(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, "\u6BDB\u68D2\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/_react.default.createElement(_antd.Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u6BDB\u68D2\u7F16\u7801"), /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
    title: tipTitleP
    ...
    className: "qt-query-form-item"
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u51FA\u68D2\u65F6\u95F4"), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_antd.Form.Item, {
    name: "OUTTIME",
    format: dateFormat
...
var _default = (0, _dva.connect)(mapStateToProps)(SketchyBarTrace);
