...
var SquareBarTrace = function SquareBarTrace(_ref) {
  ...
  var _useState15 = (0, _react.useState)([]),
      ...
      organizationFields = _useState16[0],
      setOrganizationFields = _useState16[1];
  ...
  var _useState19 = (0, _react.useState)([]),
      ...
      selectedRowKey = _useState20[0],
      setSelectedRowKey = _useState20[1];

  (0, _react.useEffect)(function () {
    setTableHeight("calc(100% - ".concat(queryBox.current.offsetHeight, "px - 15px)"));
    (0, _traceApi.squareBarSearchFields)().then(function (data) {
      if (data) {
        var _organizationFields = [];
        _organizationFields = data.squareBarOrganizationFields && data.squareBarOrganizationFields.filter(function (item) {
  ...
  var columns = [].concat(_toConsumableArray(_TableColumns.squareBarTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 120,
    ...
    render: function render(record) {
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
        ...
        onClick: function onClick() {
          (0, _utils.toGFTrackPage)(record, 'fb');
        }
  ...
  var showDetails = function showDetails(record) {
    return function () {
      ...
      value.PKSQUAREBAR = record.PKSQUAREBAR;
      dispatch({
  ...
  var onFinish = function onFinish(values) {
    ...
    (0, _traceApi.squareBarQuery)(_objectSpread({
      page: page,
      pageSize: pageSize
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return (0, _traceApi.squareBarQuery)(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  }, "\u65B9\u68D2\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/_react.default.createElement(_antd.Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/_react.default.createElement("div", {
...
function mapStateToProps(_ref5) {
  var squareBarTraceCmp = _ref5.squareBarTraceCmp;
  return _objectSpread({}, squareBarTraceCmp);
}

var _default = (0, _dva.connect)(mapStateToProps)(SquareBarTrace);
