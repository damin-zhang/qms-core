...
var PrintTrace = function PrintTrace(_ref) {
  ...
  var _useState15 = (0, _react.useState)([]),
      ...
      sampleOrganizationFields = _useState16[0],
      setSampleOrganizationFields = _useState16[1];
  ...
  (0, _react.useEffect)(function () {
    ...
    (0, _traceApi.sampleSearchFields)().then(function (data) {
      if (data) {
        var _sampleOrganizationFields = [];
        _sampleOrganizationFields = data.sampleOrganizationFields && data.sampleOrganizationFields.filter(function (item) {
          return item !== null && item;
        });
        setSampleOrganizationFields(_sampleOrganizationFields);
      }
    });
  }, []);
  var columns = [].concat(_toConsumableArray(_TableColumns.printTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 60,
    ...
    render: function render(record) {
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_antd.Button, {
        ...
        onClick: function onClick() {
          (0, _utils.toGFTrackPage)(record, 'yp');
        }
      }, "\u8FFD\u6EAF"));
    }
  }]);
  ...
  var onFinish = function onFinish(values) {
    setLoading(true);
    (0, _traceApi.sampleQuery)(_objectSpread({
      page: page,
      pageSize: pageSize
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return (0, _traceApi.sampleQuery)(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  var onRow = function onRow() {}; ///表格选中行
  ...
  }, "\u6837\u7247\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/_react.default.createElement(_antd.Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, sampleOrganizationFields && sampleOrganizationFields.map(function (item, index) {
