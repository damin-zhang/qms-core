...
import { isEnglish, showLoading } from '../../utils/utils';
var warning = Modal.warning;

var showConfirm = function showConfirm() {
  var title = isEnglish ? 'Please log in again' : '请重新登录';
  var msg = isEnglish ? 'You are offline, and your account is logged in on another client' : '你已离线, 账户在另一台客户端登录';
  warning({
    title: title,
