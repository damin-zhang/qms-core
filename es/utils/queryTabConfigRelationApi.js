 ...
 */
// 返回表名映射
export var queryModelMap = function queryModelMap(tableName) {
  var tn = null;
...
export var queryRelationPropertyQueryApi = function queryRelationPropertyQueryApi(tableNameMap, objectType) {
  var path = null;
...
export var queryRelationPropertySecondPath = function queryRelationPropertySecondPath(tableNameMap) {
  var path = null;
...
export var metaObjectParameters = function metaObjectParameters(tableNameMap, _ref, type) {
