...
import './index.css';
import { squareBarQuery, squareBarSearchFields } from '../../service/traceApi';
import { squareBarTraceCols } from './TableColumns';
...
var SquareBarTrace = function SquareBarTrace(_ref) {
  ...
  useEffect(function () {
    ...
    squareBarSearchFields().then(function (data) {
      if (data) {
  ...
  var columns = [].concat(_toConsumableArray(squareBarTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 120,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return squareBarQuery(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  }, "\u65B9\u68D2\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/React.createElement(Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/React.createElement("div", {
...
export default connect(mapStateToProps)(SquareBarTrace);