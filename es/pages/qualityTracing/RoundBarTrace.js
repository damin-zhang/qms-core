...
import './index.css';
import { shortRodQuery, shortRodSearchFields } from '../../service/traceApi';
import { roundBarTraceCols } from './TableColumns';
...
var RoundBarTrace = function RoundBarTrace() {
  ...
  useEffect(function () {
    ...
    shortRodSearchFields().then(function (data) {
      if (data) {
  ...
  var columns = [].concat(_toConsumableArray(roundBarTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 60,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return shortRodQuery(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  }, "\u77ED\u5706\u68D2\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/React.createElement(Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\u77ED\u5706\u68D2\u6279\u6B21\u53F7"), /*#__PURE__*/React.createElement(Tooltip, {
    title: tipTitleP
