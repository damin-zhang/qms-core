...
import './index.css';
import { productQuery, productSearchFields } from '../../service/traceApi';
import { productTraceCols } from './TableColumns';
...
var ProductTrace = function ProductTrace(_ref) {
  ...
  useEffect(function () {
    ...
    productSearchFields().then(function (data) {
      if (data) {
        var _companyFields = [];
  ...
  var columns = [].concat(_toConsumableArray(productTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 120,
    ...
    render: function render(record) {
      return /*#__PURE__*/React.createElement(React.Fragment, null, (record.BASEUNITNAME === '四川永祥新能源有限公司' || record.BASEUNITNAME === '四川永祥光伏科技有限公司') && /*#__PURE__*/React.createElement(Button, {
        type: "primary",
        onClick: function onClick() {
          if (record.BASEUNITNAME === '四川永祥新能源有限公司') {
            toXNYTrackPage(record, 'xnycp');
          } else if (record.BASEUNITNAME === '四川永祥光伏科技有限公司') {
            toGFTrackPage(record, 'cp');
          }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return productQuery(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u5149\u4F0F\u4EA7\u54C1\u67E5\u8BE2"), /*#__PURE__*/React.createElement(Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\u7EC4\u7EC7"), /*#__PURE__*/React.createElement(Tooltip, {
    title: tipTitleP
    ...
    className: "qt-query-form-item"
  }, /*#__PURE__*/React.createElement("span", null, "\u5BA2\u6237\u7F16\u53F7"), /*#__PURE__*/React.createElement(Tooltip, {
    title: tipTitleZ
  }, /*#__PURE__*/React.createElement(Form.Item, {
    name: "CUSTOMERNUM"
  }, /*#__PURE__*/React.createElement(AutoComplete, {
    ...
    className: "qt-query-form-item"
  }, /*#__PURE__*/React.createElement("span", null, "\u5BA2\u6237\u540D\u79F0"), /*#__PURE__*/React.createElement(Tooltip, {
    title: tipTitleS
  }, /*#__PURE__*/React.createElement(Form.Item, {
    name: "CUSTOMERNAME"
  }, /*#__PURE__*/React.createElement(AutoComplete, {
    ...
    className: "qt-query-form-item"
  }, /*#__PURE__*/React.createElement("span", null, "\u53D1\u8D27\u65F6\u95F4"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Form.Item, {
    name: "FAUDITTIME",
    format: dateFormat
...
export default connect(mapStateToProps)(ProductTrace);