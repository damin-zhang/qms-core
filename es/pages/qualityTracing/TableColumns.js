...
import { Tooltip } from 'antd'; // 原材料主表

export var rawMaterialCols = [{
  title: '原材料批次',
  dataIndex: 'FLOT',
  align: 'center',
  width: 143,
...
export var polySiliconTraceCols = [{
  title: '入库ID',
  dataIndex: 'ID',
  align: 'center',
  width: 150,
...
export var cutRoundBarTraceCols = [{
  title: '反截棒批次',
  dataIndex: 'PICINO',
  align: 'center',
  width: 143,
...
export var sketchyBarTraceCols = [{
  title: '毛棒编码',
  dataIndex: 'CODE',
  align: 'center',
  width: 142,
...
export var recycleMaterialCols = [{
  title: '回收料编码',
