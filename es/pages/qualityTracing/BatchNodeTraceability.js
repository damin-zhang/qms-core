...
import { DatePicker, Button, Input, Form, Tooltip, Select, AutoComplete, Modal, Spin, message } from 'antd';
import { queryCpNodeData, queryDybNodeData, queryFbNodeData, queryFjdybNodeData, queryMBNodeData, queryThNodeData, queryXsdhNodeData, queryYclNodeData, queryYpNodeData } from '../../service/traceApi';
...
import SketchyBarTraceCmp from '../../component/qualityTracing/SketchyBarTraceCmp';
import SquareBarTraceCmp from '../../component/qualityTracing/SquareBarTraceCmp';
import QualityDetail from '../../component/qualityTracing/QualityDetailForm';
import CutRoundBarTraceCmp from '../../component/qualityTracing/CutRoundBarTraceCmp';
import { rawMaterialCols, // 原材料
productTraceCols, // 光伏产品
polySiliconTraceCols, // 多晶硅产品
printTraceCols, // 样片
cutRoundBarTraceCols, // 反截短圆棒
sketchyBarTraceCols, // 毛棒
roundBarTraceCols, // 短圆棒
squareBarTraceCols, // 方棒
recycleMaterialCols // 回收料
} from './TableColumns';
import YpQualityDetailTable from '../../component/qualityTracing/YpQualityDetailTable';
/* 原材料 - 光伏产品 - 多晶硅产品 - 样片 - 反截短圆棒 - 毛棒 - 短圆棒 - 方棒 - 回收料 */

var mainTableCols = {
  ycl: rawMaterialCols,
  mb: sketchyBarTraceCols,
  dyb: roundBarTraceCols,
  fb: squareBarTraceCols,
  cp: productTraceCols,
  fjdyb: cutRoundBarTraceCols,
  hsl: recycleMaterialCols,
  yp: printTraceCols
};
var FlotFields = {
  ycl: 'FLOT',
...
var Api = {
  ycl: queryYclNodeData,
  mb: queryMBNodeData,
  dyb: queryDybNodeData,
  fb: queryFbNodeData,
  hsl: '',
  yp: queryYpNodeData,
  fjdyb: queryFjdybNodeData,
  cp: queryXsdhNodeData,
  th: queryThNodeData,
  xsdh: queryXsdhNodeData
};
...
var BatchNodeTraceability = function BatchNodeTraceability(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u4EA7\u54C1\u8FFD\u6EAF\u94FE"), /*#__PURE__*/React.createElement(Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/React.createElement("div", {
    ...
    value: 'ycl'
  }, "\u539F\u6599"), /*#__PURE__*/React.createElement(Select.Option, {
    value: 'mb'
  }, "\u6BDB\u576F"), /*#__PURE__*/React.createElement(Select.Option, {
    value: 'dyb'
  }, "\u534A\u6210\u54C1"), /*#__PURE__*/React.createElement(Select.Option, {
    value: 'fb'
  }, "\u6210\u54C1"), /*#__PURE__*/React.createElement(Select.Option, {
    value: 'yp'
  }, "\u6837\u7247"), /*#__PURE__*/React.createElement(Select.Option, {
    value: 'cp'
  }, "\u9500\u552E"), /*#__PURE__*/React.createElement(Select.Option, {
    value: 'th'
  }, "\u5165\u5E93")))), /*#__PURE__*/React.createElement("div", {
    className: "qt-query-form-item"
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      width: 70
  ...
  }, "\u539F\u6599"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "qt-node-title"
  }, "\u6BDB\u576F"), /*#__PURE__*/React.createElement("div", {
    className: "qt-node-list"
  }, /*#__PURE__*/React.createElement("div", {
    className: "qt-node-item-container"
  }, /*#__PURE__*/React.createElement(QualityNode, _extends({
    ...
    className: "qt-node-title"
  }, "\u534A\u6210\u54C1"), /*#__PURE__*/React.createElement("div", {
    className: "qt-node-list"
  }, /*#__PURE__*/React.createElement("div", {
    className: "qt-node-item-container"
  }, /*#__PURE__*/React.createElement(QualityNode, _extends({
    ...
    className: "qt-node-title"
  }, "\u9500\u552E"), /*#__PURE__*/React.createElement("div", {
    className: "qt-node-list"
  }, /*#__PURE__*/React.createElement("div", {
    className: "qt-node-item-container"
  }, /*#__PURE__*/React.createElement(QualityNode, _extends({
    ...
    dataList: chengPinKeHuIdAndTuoHaoResult,
    type: "kh"
  }, qtNodeProps)))))))))), /*#__PURE__*/React.createElement(ProductDetailCmp, {
    ...
    onClose: onClose
  }), /*#__PURE__*/React.createElement(SketchyBarTraceCmp, {
    visible: sketchyBarTraceCmp.BatchNodeDetail,
    onClose: onClose
  }), /*#__PURE__*/React.createElement(SquareBarTraceCmp, {
    visible: squareBarTraceCmp.BatchNodeDetail,
    onClose: onClose
  }), /*#__PURE__*/React.createElement(CutRoundBarTraceCmp, {
    ...
    visible: displayPage,
    footer: null
  }, displayPage && nodeDetailType !== 'yp' && /*#__PURE__*/React.createElement(QualityDetail, {
    data: mainTableCols[nodeDetailType],
    init: nodeDetail
  }), displayPage && nodeDetailType === 'yp' && /*#__PURE__*/React.createElement(YpQualityDetailTable, {
    dataList: nodeDetail
  })));
};
...
export default connect(mapStateToProps)(BatchNodeTraceability);