...
import './index.css';
import { reverseTruncatedRoundBarQuery, cutRoundBarDetailsQuery } from '../../service/traceApi';
import { cutRoundBarTraceCols } from './TableColumns';
import { toGFTrackPage, toXNYTrackPage } from './utils';

var RoundBarTrace = function RoundBarTrace(_ref) {
  ...
  var _useState15 = useState([]),
      ...
      cutRoundBarFields = _useState16[0],
      setCutRoundBarFields = _useState16[1];
  ...
  useEffect(function () {
    ...
    cutRoundBarDetailsQuery().then(function (data) {
      if (data) {
        var _cutRoundBarFields = [];
        _cutRoundBarFields = data.reverseTruncatedRoundBarOrganizationFields && data.reverseTruncatedRoundBarOrganizationFields.filter(function (item) {
        ...
        setCutRoundBarFields(_cutRoundBarFields);
      }
    });
  }, []);
  var columns = [].concat(_toConsumableArray(cutRoundBarTraceCols), [{
    title: '明细',
    dataIndex: '',
    align: 'center',
    width: 120,
  ...
  var showDetails = function showDetails(record) {
    return function () {
      ...
      value.PKREVERSETRUNCATEDROUNDBAR = record.PKREVERSETRUNCATEDROUNDBAR;
      dispatch({
  ...
  var onFinish = function onFinish(values) {
    setLoading(true); // if (values.FAUDITTIME) {
    ...
    reverseTruncatedRoundBarQuery(_objectSpread({
      page: page,
      pageSize: pageSize
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 4;
              return reverseTruncatedRoundBarQuery(_objectSpread({
                page: page,
                pageSize: pageSize
  ...
  }, "\u53CD\u622A\u77ED\u5706\u68D2\u6279\u6B21\u67E5\u8BE2"), /*#__PURE__*/React.createElement(Form, {
    onFinish: onFinish,
    form: form
  }, /*#__PURE__*/React.createElement("div", {
...
function mapStateToProps(_ref5) {
  var cutRoundBarTraceCmp = _ref5.cutRoundBarTraceCmp;
  return _objectSpread({}, cutRoundBarTraceCmp);
}

export default connect(mapStateToProps)(RoundBarTrace);