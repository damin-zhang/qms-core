...
import QueryViewCmp from '../../component/configPlatform/queryView/QueryViewCmp';
...
var common = language.common,
    ...
    fields = _language$configPlatf.queryView.fields; // 根据STATE值渲染NAME字段
...
var QueryView = function QueryView(_ref) {
  ...
  var dataList = queryView.dataList,
      visible = queryView.visible,
      selectedRowKeys = queryView.selectedRowKeys,
      selectedRows = queryView.selectedRows,
      activeKey = queryView.activeKey,
      activeTab = queryView.activeTab,
      namespace = queryView.namespace,
      showTab = queryView.showTab,
      record = queryView.record,
      noFooter = queryView.noFooter,
      total = queryView.total,
      _queryView$paging = queryView.paging,
      paging = _queryView$paging === void 0 ? {
    showPaging: true
  } : _queryView$paging,
      _queryView$isSearch = queryView.isSearch,
      isSearch = _queryView$isSearch === void 0 ? false : _queryView$isSearch,
      page = queryView.page,
      pageNumber = queryView.pageNumber;
