...
import NavMenuCmp from '../../component/configPlatform/navMenu/NavMenuCmp';
import { Checkbox, Tag, Menu, Dropdown, message, Button } from 'antd';
import { DownOutlined } from '@ant-design/icons';
import { facetypeMap } from '../../utils/mapParams';
...
var NavMenu = function NavMenu(_ref) {
  ...
  var operationMenu = /*#__PURE__*/React.createElement(Menu, null, /*#__PURE__*/React.createElement(Menu.Item, {
    disabled: !isModeling,
    onClick: function onClick() {
      return toogleModal(selectedRows[0]);
    }
  }, buttons.update), /*#__PURE__*/React.createElement(Menu.Item, {
    disabled: !isModeling,
    onClick: function onClick() {
      return confirm({
  ...
  var operationColmun = /*#__PURE__*/React.createElement(Dropdown, {
  ...
  var columns = [{
    ...
    render: function render(text) {
      var fType = facetypeMap.find(function (item) {
        return item.value === text;
      });
      return fType ? text >= 0 ? /*#__PURE__*/React.createElement(Tag, {
        color: fType.color
    ...
    render: function render(text) {
      ...
      if (text.indexOf('third-') != -1) {
        ...
        return IconView && /*#__PURE__*/React.createElement(IconView, {
          style: {
            color: '#1890ff'
          }
        });
  ...
  // { title: fields.CUSER, dataIndex: 'USERNAME' }
  {
    ...
    fixed: 'right',
    render: function render(text, record) {
      return /*#__PURE__*/React.createElement(React.Fragment, null, record.META.FACETYPE > 0 && record.META.FACETYPE !== 8 && /*#__PURE__*/React.createElement(Button, {
        size: "small",
        type: "primary",
  ...
  var onSearchOpen = function onSearchOpen(value) {
    ...
    var parentKey = dataList.map(function (item) {
      var cp = item.NO.toUpperCase().indexOf(value.toUpperCase()) > -1 || (isEnglish ? item.ENNAME && item.ENNAME.toUpperCase().indexOf(value.toUpperCase()) > -1 : item.NAME.toUpperCase().indexOf(value.toUpperCase()) > -1);
  ...
  return /*#__PURE__*/React.createElement(NavMenuCmp, props);
};
