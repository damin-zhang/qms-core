...
import QueryViewCmp from '../../component/configPlatform/autoClass/AutoClassCmp';
import { Checkbox, Tooltip, Tag, Button, message } from 'antd';
...
var common = language.common,
    ...
    fields = _language$configPlatf.autoClass.fields;
var tab_namespace = ['viewStructure', 'menu']; // 根据STATE值渲染NAME字段
...
var AutoClass = function AutoClass(_ref) {
  var autoClass = _ref.autoClass,
  ...
  // { title: fields.VER, dataIndex: 'VER', width: 80 },
  {
    ...
    title: isEnglish ? fields.ENNAME : fields.NAME,
  ...
  var dataList = autoClass.dataList,
      visible = autoClass.visible,
      selectedRowKeys = autoClass.selectedRowKeys,
      selectedRows = autoClass.selectedRows,
      activeKey = autoClass.activeKey,
      activeTab = autoClass.activeTab,
      namespace = autoClass.namespace,
      showTab = autoClass.showTab,
      record = autoClass.record,
      noFooter = autoClass.noFooter,
      total = autoClass.total,
      _autoClass$paging = autoClass.paging,
      paging = _autoClass$paging === void 0 ? {
    showPaging: true
  } : _autoClass$paging,
      _autoClass$isSearch = autoClass.isSearch,
      isSearch = _autoClass$isSearch === void 0 ? false : _autoClass$isSearch,
      page = autoClass.page,
      pageNumber = autoClass.pageNumber;
  ...
  var cancelUpgradeObject = function cancelUpgradeObject(rows) {
    dispatch({
  ...
  var workObjectBtns = [{
    ...
    func: function func() {
      confirm({
        ...
        onOk: function onOk() {
          STATE === 2 ? cancelUpgradeObject(selectedRows) : del(selectedRows)();
        }
      });
    }
  }, {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.t1 = searchWorkObject;
              _context.next = 10;
              break;

            case 9:
              _context.t1 = searchObject({
                tn: 2,
                paging: true,
                page: current,
                pageSize: pageSize,
            ...
            case 15:
              ...
              _context.t3 = queryWorkObject;
              _context.next = 21;
              break;

            case 20:
              _context.t3 = queryObject({
                tn: 2,
                paging: true,
                page: current,
                pageSize: pageSize
  ...
  var tabsProps = [{
    caption: isEnglish ? 'Synced' : '已同步',
    key: '1'
  }, {
    caption: isEnglish ? 'Designing' : '设计中',
    key: '2',
    disabled: !isModeling
  }];
  var tabsTableProps = {
