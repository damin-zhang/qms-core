...
import ActEndProcessCmp from '../../../component/activiti/processManage/ActEndProcessCmp';
import { Button } from 'antd';
import { generatorTableKeyByIndex, showConfirm } from '../../../utils/utils';
import { processGetEndProcess, processGetEndProcessSearch } from '../../../service/processApi';
...
var ActEndProcess = function ActEndProcess(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              state = false;
              api = keyWord ? processGetEndProcessSearch : processGetEndProcess;
  ...
  return /*#__PURE__*/React.createElement(ActEndProcessCmp, props);
};
