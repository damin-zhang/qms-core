...
var _excluded = ["dispatch", "record", "dataList", "viseble1"];
...
import UserSelectorForm from '../userSelectForm';
...
var _language$common = language.common,
    ...
    title1 = _language$userManage$.title1,
  ...
  return /*#__PURE__*/React.createElement(DragModal, _extends({
    ...
    rules: [{
      ...
      validator: function validator(_, value) {
        return checkRepeat(value, 'name', dataList, record.id);
      }
    }]
    ...
    rules: [{
      ...
      validator: function validator(_, value) {
        return checkRepeat(value, 'ename', dataList, record.id);
      }
    }]
  }, /*#__PURE__*/React.createElement(Input, null)), /*#__PURE__*/React.createElement(Item, {
    name: "tel",
    ...
    width: 500,
    height: 400,
    title: select + '' + fields.MANAGE,
    visible: viseble1,
    onCancel: toomodels,
    onOk: selectOk
  }, viseble1 && /*#__PURE__*/React.createElement(UserSelectorForm, _extends({}, objectProps, {
    ref: childRef,
    form: form,
    editor: 'UserSelector'
  }))));
