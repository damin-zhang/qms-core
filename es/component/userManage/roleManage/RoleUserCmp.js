...
import { queryAddRoleUser } from '../../../service/systemApi';
...
var common = language.common,
    _language$userManage$ = language.userManage.roleManage.roleUser,
...
var Index = function Index(_ref) {
  var dispatch = _ref.dispatch,
      dataList2 = _ref.dataList2,
      dataList2_1 = _ref.dataList2_1,
      dataList4 = _ref.dataList4,
      ...
      selectedRowKeys2_1 = _ref.selectedRowKeys2_1,
      _ref$selectedRows2_ = _ref.selectedRows2_1,
      selectedRows2_1 = _ref$selectedRows2_ === void 0 ? [] : _ref$selectedRows2_,
  ...
  var addUser = function addUser() {
    if (selectedRows2_1 && selectedRows2_1.length > 0) {
      dispatch({
        type: 'RoleManage/addRoleUser',
        payload: {
          hData: selectedRows2_1,
  ...
  var remove = function remove() {
    dispatch({
      type: 'RoleManage/removeRoleUser',
      payload: {
        hData: selectedRows2,
        objectAData: selectedRows[0]
      }
  ...
  var onSearch = function onSearch(keyWord) {
    setKeyWord(keyWord);
    dispatch({
      type: 'RoleManage/searchAllUsers',
      payload: {
        keyWord: keyWord,
        page: 1,
        pageSize: 20,
  ...
  var btns = [{
    name: buttons.add_user,
    func: function func() {
      dispatch({
        type: 'RoleManage/queryAddRoleUser',
        payload: {
          roleId: selectedRows[0].id,
          visible3: !visible3,
          page: 1,
    ...
    name: buttons.remove_user,
    disabled: !ID,
    func: function func() {
      confirm({
        title: common.confirm + buttons.remove_user,
        onOk: remove
      });
    }
  }];
    ...
    rowSelection: {
      onChange: function onChange(keys, rows) {
        dispatch({
          type: 'RoleManage/packet',
          payload: {
            selectedRows2_1: rows,
            selectedRowKeys2_1: keys
          }
        });
      },
      selectedRowKeys: selectedRowKeys2_1
    },
    rowKey: 'ID'
  };
  ...
  }, /*#__PURE__*/React.createElement(TableWithBtn, tableProp1)));
};

function mapStateToProps(_ref4) {
  var RoleManage = _ref4.RoleManage;
