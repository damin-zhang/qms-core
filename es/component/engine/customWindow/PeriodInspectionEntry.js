...
import { Table, Form, message, Button, Select, DatePicker, Upload, Input, Tooltip } from 'antd';
...
var PeriodInspectionEntry = function PeriodInspectionEntry(_ref) {
  ...
  var definitionColumns = [{
    ...
    render: function render(text, record, index) {
      ...
      } else return /*#__PURE__*/React.createElement("span", null, record.INSPECT_TIME);
    }
  }, {
    title: '计划完成时间',
    ...
    render: function render(text, record, index) {
      ...
      } else return /*#__PURE__*/React.createElement("span", null, record.ESTIMATE_C_TIME);
    }
  }, {
    title: '试验结论',
    dataIndex: 'TR ',
    ...
    render: function render(text, record, index) {
      ...
      }, "NG"), /*#__PURE__*/React.createElement(Select.Option, {
        value: "NA",
        key: "3",
        style: {
          textAlign: 'center'
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (type === 'INSPECT_TIME') {
                otherParam = (_otherParam = {}, _defineProperty(_otherParam, type, moment(val1).format(dateFormat)), _defineProperty(_otherParam, "ESTIMATE_C_TIME", record.ESTIMATE_C_TIME ? moment(record.ESTIMATE_C_TIME).format(dateFormat) : null), _otherParam);
              } else otherParam = (_otherParam2 = {}, _defineProperty(_otherParam2, type, moment(val1).format(dateFormat)), _defineProperty(_otherParam2, "INSPECT_TIME", record.INSPECT_TIME ? moment(record.INSPECT_TIME).format(dateFormat) : null), _otherParam2);
            ...
            case 6:
              ...
              if (res && res.flag) {
                dataList[index][type] = moment(val1).format(dateFormat);
                dispatch({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\u68C0\u9A8C\u5355\u53F7: ", hData && hData.INSPECTION_ORDER_NUMBER), /*#__PURE__*/React.createElement("span", null, "\u68C0\u9A8C\u65E5\u671F: ", hData && hData.IST), /*#__PURE__*/React.createElement("span", null, "\u8BD5\u9A8C\u5355\u53F7: ", hData && hData.TEST_ORDER), /*#__PURE__*/React.createElement("span", null, "\u9001\u68C0\u65E5\u671F: ", hData && hData.INSPECT_TIME), /*#__PURE__*/React.createElement("span", null, "\u7269\u6599\u7F16\u53F7: ", hData && hData.MATERIAL_CODE), /*#__PURE__*/React.createElement("span", null, "\u6837\u54C1\u6570\u91CF: ", hData && hData.SAMPLE_QUANTITY), /*#__PURE__*/React.createElement("span", null, "\u4F9B\u5E94\u5546\u54C1\u724C\u4EE3\u7801: ", hData && hData.SUPPLIER_BRAND_CODE), /*#__PURE__*/React.createElement("span", null, "\u4F9B\u5E94\u5546\u54C1\u724C: ", hData && hData.SUPPLIER_BRAND), /*#__PURE__*/React.createElement("span", {
    className: "lin-2"
  }, "\u7269\u6599\u63CF\u8FF0: ", hData && hData.MATERIAL_NAME), /*#__PURE__*/React.createElement("span", null, "\u4F9B\u5E94\u5546\u540D\u79F0: ", hData && hData.SUPPLIER_NAME))), /*#__PURE__*/React.createElement("div", {
    style: {
      height: '50px',
      lineHeight: '55px'
    }
  ...
  }, "\u6279\u91CFNG"), /*#__PURE__*/React.createElement(Upload, {
    ...
    type: "primary",
    disabled: dataList.length && hData.INSPECTION_STATUS !== 2 && !isOperation ? false : true
  }, "\u4E0A\u4F20\u62A5\u544A")), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    disabled: dataList.length && hData.INSPECTION_STATUS !== 2 && !isOperation ? false : true,
    onClick: function onClick() {
      return setNAVisible(true);
    }
  }, "\u7533\u8BF7\u4E0D\u5B89\u6392\u8BD5\u9A8C")), /*#__PURE__*/React.createElement("div", {
    style: {
...
export default connect(mapStateToProps)(PeriodInspectionEntry);