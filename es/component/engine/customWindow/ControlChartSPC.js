...
var ControlChartSPC = function ControlChartSPC(_ref) {
  ...
  var onFinish = function onFinish(value) {
    if (value.keyWord) {
      value.keyWord = [moment(values.keyWord[0]).format(dateFormat), moment(values.keyWord[1]).format(dateFormat)];
  ...
  }, fieldList.SUPPLIER_BRAND, ' '), /*#__PURE__*/React.createElement("span", {
    style: {
      marginRight: 30,
      fontWeight: 'bold'
    }
  }, fieldList.SUPPLIER_NAME), /*#__PURE__*/React.createElement("span", {
    style: {
      marginRight: 30,
      fontWeight: 'bold'
    }
  }, fieldList.MATERIAL_CODE), /*#__PURE__*/React.createElement("span", {
    style: {
      marginRight: 30,
      fontWeight: 'bold'
    }
  }, fieldList.CDOIT)), /*#__PURE__*/React.createElement(Form, {
    onFinish: onFinish,
    form: form,
    layout: "inline",
    style: {
  ...
  }, USL_CL_LCL && /*#__PURE__*/React.createElement(DualAxes, _extends({}, config, {
    onReady: onReadyColumn
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
      backgroundColor: '#BFFFBF'
    }
  }, USL_LCL && /*#__PURE__*/React.createElement(DualAxes, configS))));
};
