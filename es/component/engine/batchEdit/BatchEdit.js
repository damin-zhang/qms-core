...
import EditorCmp from '../property/EditorCmp';
import dayjs from 'dayjs';
import { MinusCircleOutlined } from '@ant-design/icons';
import language from '@/locale/language';
import { confirmBtn } from '../../../utils/buttonFunc'; // 引入选择弹窗相关

import Modal from '../../common/drag/DragModal';
import ObjectSelectorForm from '../property/ObjectSelectorForm';
import ViewSelectorForm from '../property/ViewSelectorForm';
import UserSelectorForm from '../property/UserSelectorForm';
import NoSelectorForm from '../property/NoSelectorForm';
...
var BatchEdit = function BatchEdit(_ref, ref) {
  ...
  var _useState11 = useState('vertical'),
  ...
  var onFinish = function onFinish(values) {
    if (!canSubmit) {
      message.warn(common.wait_file_uploaded);
      return false;
    }
  ...
  var getEditor = function getEditor(item1, index) {
    ...
    if (record.length) {
      ...
      if (item1.editor === 'DateTime' && record[index][item1.fieldName]) props.initVal[item1.fieldName] = dayjs(record[index][item1.fieldName]);
    }

    var batchIndex = index;
    return /*#__PURE__*/React.createElement(EditorCmp, _extends({}, props, {
      batchDefend: true,
  ...
  var handleSelectValues = function handleSelectValues(res, pageFieldList) {
    pageFieldList.forEach(function (item) {
      ...
      if (editor === 'DateTime') {
        res[fieldName] = dayjs(res[fieldName]); // } else if (editor === 'UsersSelector' || editor === 'CheckEditor') {
        ...
        res[fieldName] = BraftEditor.createEditorState(res[fieldName]);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, !record.length && /*#__PURE__*/React.createElement(Button, {
    ...
    className: row ? ' ' : styles.x
  }, /*#__PURE__*/React.createElement("span", {
    className: (styles.warp, row ? styles.hide : ' ')
  }, /*#__PURE__*/React.createElement(Form, null, pageFieldList.map(function (item) {
    var name = item.name,
        allowNull = item.allowNull;
    ...
    className: row ? styles.y : styles.flex
    ...
    }), !record.length && /*#__PURE__*/React.createElement(MinusCircleOutlined, {
      style: {
        lineHeight: '32px',
        marginTop: '5px',
        marginLeft: '20px'
  ...
  }))))), namespace && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Modal, _extends({}, container, {
    title: common.select,
    ...
    onOk: selectOk
  }), editor === 'ObjectSelector' && /*#__PURE__*/React.createElement(ObjectSelectorForm, _extends({}, objectProps, {
    ref: childRef,
    form: form,
    objectAData: objectAData
  })), editor === 'ViewSelector' && /*#__PURE__*/React.createElement(ViewSelectorForm, _extends({}, objectProps, {
    ref: childRef,
    form: form,
    objectAData: objectAData
  })), (editor === 'UserSelector' || editor === 'UsersSelector') && /*#__PURE__*/React.createElement(UserSelectorForm, _extends({}, objectProps, {
    ref: childRef,
    editor: editor
  })), editor === 'OnSelector' && /*#__PURE__*/React.createElement(NoSelectorForm, _extends({}, objectProps, {
    ref: childRef,
