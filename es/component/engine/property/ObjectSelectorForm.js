...
import { objectSelectorQuery } from '../../../service/queryDataApi';
...
var ObjectSelectorForm = function ObjectSelectorForm(_ref, ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              state = false;
              _context.next = 8;
              return objectSelectorQuery(queryParams).then(function (res) {
                if (res) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading ? /*#__PURE__*/React.createElement(TableWithBtn, tabProps) : /*#__PURE__*/React.createElement(Spin, {
    delay: 100,
    style: {
      lineHeight: '600px',
      width: '100%',
...
export default forwardRef(ObjectSelectorForm);