...
var PicturesWall = function PicturesWall(_ref) {
  ...
  var handleChange = function handleChange(_ref3) {
    ...
    if (fileList.length > imgMaximum) {
      var errMsg = isEnglish ? "You can only upload up to ".concat(imgMaximum, " pictures") : "\u6700\u591A\u53EA\u80FD\u4E0A\u4F20".concat(imgMaximum, "\u5F20\u56FE\u7247");
  ...
  var beforeUpload = function beforeUpload(file) {
    ...
    if (!validType) {
      var errMsg = isEnglish ? "You can only upload ".concat(typeList.toLocaleString(), " image") : "\u53EA\u80FD\u4E0A\u4F20".concat(typeList.toLocaleString(), " \u683C\u5F0F\u7684\u56FE\u7247");
      message.error(errMsg, 5);
      return false;
    }
    ...
    if (!validSize) {
      var _errMsg = isEnglish ? "Image must smaller than ".concat(imgMaxSize, "MB!") : "\u56FE\u7247\u5FC5\u987B\u5C0F\u4E8E".concat(imgMaxSize, "MB");

      message.error(_errMsg, 5);
      return false;
    }
  ...
  var customRequest = function customRequest(_ref4) {
    ...
    requestApi({
      ...
      if (res && res.flag === true) {
        ...
        onError(function () {
          var msg = isEnglish ? '图片加载失败' : 'Image loading failed';
          message.error(msg);
        });
      }
    }).catch(function (e) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Upload, {
    ...
    disabled: disabled
  }, imgList.length >= imgMaximum ? null : uploadButton), imgList && imgList.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'none'
    }
  }, /*#__PURE__*/React.createElement(RcViewer, {
    options: {
      zIndex: 99999,
      hide: function hide() {
