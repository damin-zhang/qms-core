...
import { Form, Divider, message, Tabs, Collapse } from 'antd';
import EditorCmp from './EditorCmp';
import { confirmBtn } from '../../../utils/buttonFunc';
import ObjectSelectorForm from './ObjectSelectorForm';
import ViewSelectorForm from './ViewSelectorForm';
import NewUserSelectorFrom from './NewUserSelectorFrom';
...
import { getCaption, isEnglish, isUpdate } from '../../../utils/utils';
...
var PropertyForm = function PropertyForm(_ref, ref) {
  ...
  var _useState7 = useState(initVal),
  ...
  var _useState15 = useState(fieldList),
      _useState16 = _slicedToArray(_useState15, 2),
      pageFieldList = _useState16[0],
      setPageFieldList = _useState16[1];

  var _useState17 = useState(peptideList),
  ...
  var onFinish = function onFinish(values) {
    ...
    var isChange = JSON.stringify(record) === '{}' ? true : isUpdate(record, values); // 判断表单数据是否修改

    changeControl ? confirmBtn({
      values: _objectSpread(_objectSpread({}, clickedMenu.values), {}, {
        data: _objectSpread(_objectSpread({}, values), {}, {
          FLOCATION: FLOCATION
        })
      })
    }, clickedMenu, newNameSpace, pageId, tabInfo, onCancel, dataTotal) : isChange ? confirmBtn({
      values: _objectSpread(_objectSpread({}, clickedMenu.values), {}, {
        data: _objectSpread(_objectSpread({}, values), {}, {
          FLOCATION: FLOCATION
        })
  ...
  */
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Form, _extends({
  ...
  }, layout), peptide ? tiled ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tabs, {
    style: {
      width: '100%'
    }
    ...
    }, /*#__PURE__*/React.createElement(EditorCmp, _extends({}, props, {
      pageFieldList: item.pageFieldList
    }))));
  ...
  })) : /*#__PURE__*/React.createElement(EditorCmp, props)), namespace && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Modal, _extends({}, container, {
    title: common.select,
    ...
    form: form,
    objectAData: objectAData
  })), (editor === 'UserSelector' || editor === 'UsersSelector') && /*#__PURE__*/React.createElement(NewUserSelectorFrom, _extends({}, objectProps, {
    ref: childRef,
    form: form,
    editor: editor
...
export default forwardRef(PropertyForm);