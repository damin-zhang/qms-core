...
import { Checkbox, Rate, Tooltip, Button, Tag, Upload, Form, Input, InputNumber, Select, message } from 'antd';
import { isEnglish } from '../../../utils/utils';
/* 头部检验单编辑器渲染 */

export var HeaderEditorCmp = function HeaderEditorCmp(_ref) {
  ...
  switch (params.EDITOR) {
    case 'MapValueList':
      Cmp = /*#__PURE__*/React.createElement("p", {
        style: params.WLINE ? {
          width: '100%'
        } : {}
...
export var setInspectionColumns = function setInspectionColumns(_ref2) {
  ...
  var columns = filedList.map(function (item, index) {
    ...
    var render = function render(text, record, i) {
      ...
      switch (item.EDITOR) {
        case 'MapValueList':
          if (EDITABLE) {
            Cmp = /*#__PURE__*/React.createElement(Form.Item, {
              name: [record.InspectionItem.ID, 'InspectionItem', FIELDNAME]
            }, /*#__PURE__*/React.createElement(Select, selectProps, EDITPARAMS.values.map(function (item) {
              /*#__PURE__*/
            ...
            Cmp = /*#__PURE__*/React.createElement(React.Fragment, null, EDITPARAMS.values.filter(function (item) {
        ...
        case 'TextBox':
          if (item.EDITABLE) {
            Cmp = /*#__PURE__*/React.createElement(Form.Item, {
              name: [record.InspectionItem.ID, 'InspectionItem', FIELDNAME]
            }, type === 'number' ? /*#__PURE__*/React.createElement(InputNumber, inputProps) : /*#__PURE__*/React.createElement(Input, inputProps));
          } else {
        ...
        case 'TextArea':
          Cmp = /*#__PURE__*/React.createElement(Form.Item, {
            name: [record.InspectionItem.ID, 'InspectionItem', FIELDNAME]
          }, /*#__PURE__*/React.createElement(Input.TextArea, inputProps));
          break;
        ...
        case 'DBValueListMultiple':
          ...
          }, DBValueData.length || DBValueData2.length ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Select.Option, {
            disabled: true,
    ...
    return {
      title: function title() {
        ...
        }, /*#__PURE__*/React.createElement("span", null, isEnglish ? ENNAME : NAME));
      },
      dataIndex: FIELDNAME,
      align: 'center',
      width: WIDTH || 100,
  ...
  var _loop = function _loop(i) {
    columns.push({
      ...
      render: function render(text, record, index) {
        var pagingIndex = record.InspectionItem.SORT - 1;
        return record.InspectionItem.SQ > i && Number(record.InspectionItem.DT) ? record.InspectionItem.MAX_MIN ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Form.Item, {
        ...
        })) : record.InspectionItem.SQ > i && Number(record.InspectionItem.DT) == 0 && modelData.COUNTTYPECANINPUT ? /*#__PURE__*/React.createElement(Form.Item, {
          name: [record.InspectionItem.ID, 'InspectionItemResult', i, 'TV']
        }, /*#__PURE__*/React.createElement(Select, {
          id: "checkItem-".concat(i, "-").concat(pagingIndex, "-TV"),
          onChange: function onChange(value) {
  ...
  columns.unshift({
    title: isEnglish ? 'index' : '序号',
    align: 'center',
    width: 50,
    render: function render(text, record, index) {
      return /*#__PURE__*/React.createElement("span", null, record.InspectionItem.SORT);
    }
  });
  return columns;
};