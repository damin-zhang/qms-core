...
/*
 * @Description: 按钮和搜索框高阶组件
 */
import React, { useState, useEffect, useRef } from 'react';
import { Button, Tooltip, Row, Col, message, Menu, Dropdown } from 'antd';
import classNames from 'classnames';
import Search from '../../common/search/Search';
import { clickBtn } from '../../../utils/buttonFunc';
import { FileSearchOutlined, NodeCollapseOutlined, DownOutlined, ProfileTwoTone, SearchOutlined, DeleteOutlined, UnorderedListOutlined, ToolOutlined } from '@ant-design/icons';
...
import { isEnglish, confirm, showLoading } from '../../../utils/utils';
    ...
    return function (props) {
      ...
      var handleSelectedData = function handleSelectedData() {
        ...
        for (var i = 0; i < fieldLen; i++) {
          ...
          result += "".concat(isEnglish ? enName : name, "\t");
          noList.push(fieldName);
      ...
      var onClick = function onClick(item) {
        return function () {
          ...
          } else clickBtn(item, engine, model);
        };
      };
      ...
      var onSearch = function onSearch(queryWord) {
        ...
        if (faceType === 5) {
          if (model.selectedNode && model.selectedNode.length && model.selectedNode[0].loadDataSet) {
            ...
            message.warn(select_node_message);
          }
        } else {
          dispatch({
            type: "common/search",
      ...
      var getMenus = function getMenus() {
        ...
        menus.forEach(function (item, index) {
          if (item.pId === parentId) {
            ...
            var title = /*#__PURE__*/React.createElement(React.Fragment, null, item.icon && getIcon(item), isEnglish ? enName : name);
      ...
      var Cmp = menus.map(function (item) {
        if (item.mType === 1 && item.pId === 0) {
          return /*#__PURE__*/React.createElement(Dropdown, {
            disabled: item.disabled,
            trigger: ['click'],
            overlay: /*#__PURE__*/React.createElement(Menu, null, getMenus(menus, item.id))
          }, /*#__PURE__*/React.createElement(Button, null, isEnglish ? item.enName : item.name, " ", /*#__PURE__*/React.createElement(DownOutlined, null)));
        } else if (item.pId === 0) {
      ...
      }, export_selected_data), /*#__PURE__*/React.createElement(Item, {
        disabled: dataTotal ? false : true,
        key: -2,
        onClick: exportData(1)
      }, export_table_data), /*#__PURE__*/React.createElement(Item, {
        disabled: dataTotal ? false : true,
        key: -3,
        onClick: exportAllData
      }, export_all_data), /*#__PURE__*/React.createElement(Item, {
        disabled: selectedRows.length ? false : true,
        key: -5,
        onClick: copySelectData
      }, copy_select_data));
      return /*#__PURE__*/React.createElement(React.Fragment, null, showSearch && /*#__PURE__*/React.createElement("div", {
        className: styles.advancedSearchWrapper,
        style: {
          maxHeight: '30%',
          minHeight: objectSupportQueryFields && objectSupportQueryFields.length < 4 ? 'auto' : '110px'
        }
      }, /*#__PURE__*/React.createElement(Row, {
        className: classNames([styles.advancedSearch, styles.advancedSearchFormWrapper])
        ...
        return /*#__PURE__*/React.createElement(PropertyForm, {
          tableName: tableName,
          ref: childRef,
        ...
        className: styles.advancedSearchBtnWrapper,
        style: {
          marginBottom: '5px'
        }
      ...
      }, rType === 'classRelationpage' && /*#__PURE__*/React.createElement(Tooltip, {
      ...
      })), /*#__PURE__*/React.createElement("div", null, Cmp), /*#__PURE__*/React.createElement("div", {
        style: {
          flexGrow: 1,
          minWidth: supQuery === true ? '20%' : 0
        }
      }, supQuery === true && /*#__PURE__*/React.createElement(Search, {
        onSearch: onSearch,
        disabled: showSearch ? true : false
      })), objectSupportQueryFields && objectSupportQueryFields[0] && supQuery === true && rType !== 'classRelationpage' && /*#__PURE__*/React.createElement(Tooltip, {
        ...
        type: "primary"
      }, /*#__PURE__*/React.createElement(ToolOutlined, null))))), /*#__PURE__*/React.createElement(WrappedComponent, props));
    };
  };
});