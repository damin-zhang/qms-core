...
import { DatePicker, Button, Input, Form, Divider } from 'antd';
import { DualAxes } from '@ant-design/charts';
import moment from 'moment';
import { commonApi } from '../../../service/applicationApi';
import { hideLoading, isEnglish, showLoading } from '../../../utils/utils';
...
var ControlChartSPC = function ControlChartSPC(_ref) {
  ...
  useEffect(function () {
    ...
    showLoading();
    commonApi(val).then(function (data) {
      if (data) {
        dispatch({
  ...
  var onFinish = function onFinish(value) {
    if (value.keyWord) {
      value.keyWord = [moment(value.keyWord[0]).format(dateFormat), moment(value.keyWord[1]).format(dateFormat)];
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, isEnglish ? 'Supplier Code' : '供应商代码'), " \uFF1A", ' ', /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#3FA5E9'
    }
  }, hData[0].SUPPLIER_CODE || '')), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-block',
      width: '25%'
    }
  }, /*#__PURE__*/React.createElement("span", null, isEnglish ? 'Supplier Name' : '供应商名称'), "\uFF1A", ' ', /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#3FA5E9'
    }
  }, hData[0].SUPPLIER_NAME)), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-block',
      width: '25%'
    }
  }, /*#__PURE__*/React.createElement("span", null, isEnglish ? 'Material Code' : '物料编码'), "\uFF1A", ' ', /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#3FA5E9'
    }
  }, hData[0].MATERIAL_CODE)), /*#__PURE__*/React.createElement("span", {
    style: {
      display: 'inline-block',
      width: '25%'
    }
  }, /*#__PURE__*/React.createElement("span", null, isEnglish ? 'Inspection Item' : '检验项目'), "\uFF1A", ' ', /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#3FA5E9'
    }
  }, hData[0].CDOIT)), /*#__PURE__*/React.createElement(Form, {
    onFinish: onFinish,
    form: form,
    layout: "inline",
    style: {
  ...
  }, UCL_CL_LCL && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Divider, null, /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 'bold',
      color: '#032378'
    }
  }, isEnglish ? 'Mean Value' : '均值')), /*#__PURE__*/React.createElement("div", {
    style: {
      height: "".concat(meanHeight, "px"),
      background: ''
    }
  }, /*#__PURE__*/React.createElement(DualAxes, _extends({}, config, {
    onReady: onReadyColumn
  }))))), USL_LCL && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#BFFFBF'
    }
  }, /*#__PURE__*/React.createElement(Divider, null, /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 'bold',
      color: '#1F3D87'
    }
  }, isEnglish ? 'Standard Deviation' : '标准差')), /*#__PURE__*/React.createElement("div", {
    style: {
      height: "".concat(standardHeight, "px")
    }
  }, /*#__PURE__*/React.createElement(DualAxes, standardDeviation)))));
};
...
export default connect(mapStateToProps)(ControlChartSPC);