 ...
 * @Description: 表格高阶组件
 */
import { camelCaseObjectAssignment, isEnglish } from '../../../utils/utils';
import Table from '../../common/table/ParseTable';
import FileView from '../relationPage/FileView';
...
var TableHoc = function TableHoc(engine) {
  return function (WrappedComponent) {
    return function (props) {
      ...
      }, /*#__PURE__*/React.createElement(WrappedComponent, props), height ? /*#__PURE__*/React.createElement("div", {
        style: {
          height: height
        }
      ...
      }, switchFileFormat && objectType === 1 ? /*#__PURE__*/React.createElement(FileView, {
        engine: engine,
        model: model,
        rowSelection: rowSelection
      }) : /*#__PURE__*/React.createElement(Table, {
