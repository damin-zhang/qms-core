...
import NoticeIcon from '../../component/common/NoticeIcon';
import style from '../../component/common/NoticeIcon/style.less';
...
var common = language.common,
    noticeLanguage = language.header.user.notice,
    message_sent_success = language.message.notice.message_sent_success;
...
var NoticeCmp = function NoticeCmp(_ref) {
  ...
  useEffect(function () {
    if (replyMessageModalVisible) {
      ...
      var editorState = BraftEditor.createEditorState(sMessage); // 发送人为当前用户
  ...
  function getNoticeData(notices) {
    ...
    var newNotices = notices.map(function (notice) {
      ...
      if (newNotice.cTime) {
        newNotice.datetime = dayjs(notice.cTime).fromNow();
  ...
  var replyMessage = function replyMessage() {
    if (selectedRows && selectedRows.length > 0) {
      ...
      message.warn(noticeLanguage.prompt_message);
    }
  };
      ...
      dispatch({
        ...
        payload: {
          ...
          callback: function callback() {
            ...
            setReplyMessageModalVisible(!replyMessageModalVisible);
            markedRead();
            message.info(message_sent_success);
            dispatch({
              type: 'notice/packet',
              payload: {
                selectedRowKeys: []
  ...
  }, noticeLanguage.mark_read), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    onClick: replyMessage,
    label: notice.reply_message,
    disabled: selectedRows.length > 0 ? false : true
  }, noticeLanguage.reply_message)), /*#__PURE__*/React.createElement(Button, {
    onClick: handle
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    theme: theme
  }, /*#__PURE__*/React.createElement(NoticeIcon.Tab, {
    tabKey: "notice",
    ...
    onCancel: handle
  }, /*#__PURE__*/React.createElement(MessageNotification, notice)), /*#__PURE__*/React.createElement(DragModal, {
  ...
  }, replyMessageModalVisible && /*#__PURE__*/React.createElement(Form, {
    labelCol: {
      span: 3
    },
  ...
  }, html ? /*#__PURE__*/React.createElement(BraftEditor, {
    contentStyle: {
      height: 350
    },
    maxLength: 20000,
