...
import { parameterInfo, squareSamplePieceInfo, squareCutInfo } from './DetailHeadInfo';
...
var SketchyBarTraceCmp = function SketchyBarTraceCmp(_ref) {
  ...
  var parameterHeader = /*#__PURE__*/React.createElement(Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
