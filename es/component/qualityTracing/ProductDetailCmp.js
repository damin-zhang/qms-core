...
import { Drawer, Divider, Table, Tag, Tooltip, Collapse } from 'antd';
import QualityDetail from './QualityDetailForm';
import { DownOutlined, RightOutlined } from '@ant-design/icons';
import { warehousingInfo, deliveryInfo, consignmentInfo } from './DetailHeadInfo';
...
var ProductDetailCmp = function ProductDetailCmp(_ref) {
  ...
  var deliveryHeader = /*#__PURE__*/React.createElement(Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
  ...
  var consignmentHeader = /*#__PURE__*/React.createElement(Divider, {
    className: "quality",
    style: {
      margin: 0,
      padding: 0
...
export default connect(mapStateToProps)(ProductDetailCmp);