...
import { EyeFilled, PicCenterOutlined } from '@ant-design/icons';
import { showLoading } from '../../utils/utils';
import { queryYpInfoNodeData, queryFjdybInfoNodeData } from '../../service/traceApi';
import './index.css';
import { toXNYTrackPage } from '../../pages/qualityTracing/utils';
var dataIndex = {
  ycl: 'FLOT',
  mb: 'CODE',
  dyb: 'PICINO',
...
var QualityNode = function QualityNode(_ref) {
  ...
  var getContextMenu = function getContextMenu(nodeType, item) {
    ...
    switch (nodeType) {
      case 'ycl':
        ...
        }, item.SUPPLIERNAME === '四川永祥新能源有限公司' && /*#__PURE__*/React.createElement(Menu.Item, {
          key: "1",
          onClick: function onClick() {
            return toXNYTrackPage(item, 'ycl');
          }
        }, "\u8FFD\u6EAF\u591A\u6676\u7845\u4EA7\u54C1"), /*#__PURE__*/React.createElement(Menu.Item, {
          key: "2",
          onClick: function onClick() {
            openBatchInfo({
              type: nodeType,
        ...
        }, "\u67E5\u770B\u6279\u6B21\u4FE1\u606F"), /*#__PURE__*/React.createElement(Menu.Item, {
          key: "3",
          onClick: openDetails
        }, "\u67E5\u770B\u6279\u6B21\u660E\u7EC6"));
        break;
      ...
      case 'mb':
        ...
        }, "\u67E5\u770B\u6837\u7247\u4FE1\u606F"), /*#__PURE__*/React.createElement(Menu.Item, {
          key: "2",
          onClick: function onClick() {
            openBatchInfo({
              type: nodeType,
      ...
      case 'dyb':
        menu = /*#__PURE__*/React.createElement(Menu, {
          className: "qt-contextMenu"
        }, item.MARK && item.MARK !== '0' && /*#__PURE__*/React.createElement(Menu.Item, {
          key: "1",
          onClick: function onClick() {
            openFQDYBInfo(item);
          }
        }, "\u67E5\u770B\u53CD\u622A\u77ED\u5706\u68D2\u4FE1\u606F"), item.MARK && item.MARK !== '0' && /*#__PURE__*/React.createElement(Menu.Item, {
          key: "2",
          onClick: openFQDYBDetails
        }, "\u67E5\u770B\u53CD\u622A\u77ED\u5706\u68D2\u660E\u7EC6"), /*#__PURE__*/React.createElement(Menu.Item, {
          key: "3",
          onClick: function onClick() {
            openBatchInfo({
              type: nodeType,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, dataList && dataList.length > 0 && dataList.map(function (item) {
    ...
    }, item.MARK && item.MARK !== '0' && /*#__PURE__*/React.createElement("div", {
      className: "cutOff-mark"
    }), type && type !== 'kh' && /*#__PURE__*/React.createElement("span", {
      className: "batch-no"
    }, item[dataIndex[type]]), type === 'kh' && /*#__PURE__*/React.createElement(Tooltip, {
