...
import { ergodicRoot, generatorTableKey, isEnglish, systemErgodicRoot } from '../../../utils/utils';
import { setMultipleColumns, setOldColumns } from '../../../utils/columnUtil';
import { systemAuthcodeQuery } from '../../../service/systemApi';
import { commonLikeQuery, queryProcessDetailData } from '../../../service/queryDataApi';
import { showContextMenu } from '../../../utils/contextMenuFunc';
import ProcessDetail from '../../engine/relationPage/ProcessDetail';
import { getDvaApp } from 'umi';
import ProTable from './ProTable';
import language from '@/locale/language';
var _language$table = language.table,
...
var Index = function Index(_ref) {
        ...
        if (index <= fixedIndex) {
          ...
          item.headerRenderer = function () {
            return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Tooltip, {
              title: unpin_column
            }, /*#__PURE__*/React.createElement(UnlockOutlined, {
  ...
  columns = objectGrid ? setMultipleColumns(_toConsumableArray(objectGrid.gridFieldList), model ? model.namespace : '', model, lockColumns, !objectGrid.type, showSubPage) : setOldColumns(columns);
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 4;
                  return commonLikeQuery(_objectSpread({
                    page: current,
                    pageSize: pageSize
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ProTable, _extends({
    data: isTree || objectGrid && !objectGrid.type ? dataList.length > 0 && dataList[0].hasOwnProperty('ID') ? ergodicRoot(dataList, '0', 'PID', 'ID') : systemErgodicRoot(dataList) : dataList,
    ...
    title: isEnglish ? 'The Process Of History' : '流程历史',
    ...
    zIndex: 999
  }, /*#__PURE__*/React.createElement(ProcessDetail, {
