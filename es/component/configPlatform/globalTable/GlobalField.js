...
import GridForm from './GlobalFieldForm';
...
var columns = [{
  ...
  width: 100,
  render: function render(text) {
    var fType = alignMap.find(function (item) {
  ...
  width: 100,
  render: function render(text) {
    var fType = gTypeMap.find(function (item) {
      return item.value === text;
    });
    return fType ? fType.name : text;
  }
...
var Grid = function Grid(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "flex-x"
  }, /*#__PURE__*/React.createElement(TableWithBtn, props), /*#__PURE__*/React.createElement(GridForm, formProps));
};
