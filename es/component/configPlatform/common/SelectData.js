...
import bannerList from '../../../utils/bannerNames';
import Search from '../../common/search/Search';
import * as ICON from '@ant-design/icons';
import { ReactSVG } from 'react-svg';
import './index.css';
import { queryProcedures, queryProceduresParams } from '../../../service/api';
import { queryObject, queryAllObject, queryItem, searchObject, queryGridModel, queryMetaAuthcode, searchAllObject } from '../../../service/metaApi';
import { commonApi } from '../../../service/applicationApi';
import { parseMeta } from '../../../utils/utils';
var common = language.common,
    procedures = language.configPlatform.navMenu.procedures;
...
var SelectData = function SelectData(_ref) {
  ...
  var _useState5 = useState(iconNames),
  ...
  useEffect(function () {
    if (type === 'icon') setIconMap(iconNames);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, visible && /*#__PURE__*/React.createElement(Modal, {
    ...
    zIndex: 1010,
    height: 500
  }, type === 'icon' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Search, {
    onSearch: onIconSearch
  }), iconMap.map(function (item) {
    return item.title === '第三方图标库' ? /*#__PURE__*/React.createElement("div", {
      key: item.title
    }, /*#__PURE__*/React.createElement("p", {
      style: {
        margin: '5px 0 2px 0'
      }
    }, item.title), /*#__PURE__*/React.createElement("div", null, item.names.map(function (item) {
      var newIconName = item.substring(6); //去掉第三方图标“third-”标识，获取svg图片的名称

      return /*#__PURE__*/React.createElement(Tooltip, {
        title: newIconName,
        key: newIconName
      }, /*#__PURE__*/React.createElement(Button, null, /*#__PURE__*/React.createElement(ReactSVG, {
  ...
  })) : type === 'banner' ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      flexWrap: 'wrap'
    }
  }, bannerList.map(function (name) {
    ...
    showTab: showTab
  }, /*#__PURE__*/React.createElement(TableWithBtn, _extends({}, props, {
    paging: paging
  }))), showTab && type === 'procedures' && /*#__PURE__*/React.createElement("div", {
    ...
    key: "1"
  }, /*#__PURE__*/React.createElement(TableWithBtn, props2))))))));
};
