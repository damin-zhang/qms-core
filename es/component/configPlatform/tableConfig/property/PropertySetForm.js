var _excluded = ["dispatch", "record", "namespace", "rootId", "OBJECTID"];
...
var PropertySetForm = function PropertySetForm(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(Input, null)), /*#__PURE__*/React.createElement(LocaleNameForm, null)));
};

export default connect()(PropertySetForm);