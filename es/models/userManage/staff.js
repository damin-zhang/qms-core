...
import { exportDepart as _exportDepart, exportOrganization as _exportOrganization } from '../../service/api';
import { deptUserInfo as _deptUserInfo, spersonnelQuery, queryStaffUser as _queryStaffUser, updateStaff, deleteStaff, createStaff, resetUserPassword as _resetUserPassword, createDept, updateDept, deleteDept, createStaffUser, disableStaffUser, updateStaffUser, deleteStaffUser, deptQuery, searchPersonnel, userAllowMeta, personnelChangeNode, exportInformation as _exportInformation } from '../../service/systemApi';
          ...
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return call(commonApi, {
                objectNo: 'SUSER',
                hData: hData,
                implclass: implclassMap.createUserEnv
              });
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              call = _ref25.call;
              _context12.next = 4;
              return call(_resetUserPassword, {
                data: data
              });
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              _context14.next = 5;
              return call(personnelChangeNode, {
                users: users,
                deptId: hData.id
              });
