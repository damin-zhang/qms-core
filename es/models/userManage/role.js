...
import { queryPermissions, queryRoleUser, queryRoleAuthCode, queryAllAuthCode as _queryAllAuthCode, createRole, updateRole, deleteRole, deleteRoleUser, roleAuthorization, queryAddRoleUser as _queryAddRoleUser, addRoleAuthCode as _addRoleAuthCode, addRoleUser as _addRoleUser, updateRoleAuthCode, deleteRoleAuthCode, roleQuery } from '../../service/systemApi';
import { message } from 'antd';
import { parseMeta, isEnglish, generatorTableKey } from '../../utils/utils';
export default {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 11:
              ...
              if (data) {
                data.dataList[0] = parseMeta(data.dataList[0]).map(function (item) {
                  item.caption = isEnglish ? item.ENNAME : item.NAME;
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.next = 4;
              return call(updateRoleAuthCode, {
                ETIME: value.ETIME,
                hData: hData
              });
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              _context12.next = 4;
              return call(deleteRoleAuthCode, {
                hData: hData
              });
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              _context13.next = 5;
              return call(roleAuthorization, values);
