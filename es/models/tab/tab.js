...
import { isEnglish, judgeModel, parseMeta, parseTreeMeta, removeModel, rgbRandom } from '../../utils/utils';
import { queryReportConfig } from '../../service/api';
import { querySingleModel, queryClassModel, queryAutoClassModel } from '../../service/metaApi';
import { queryDataClassFieldTotal as _queryDataClassFieldTotal } from '../../service/queryDataApi';
import Engine from '../../component/engine/Engine';
import ReportHoc from '../../component/engine/layout/ReportHoc';
import language from '@/locale/language';
var configure_report = language.message.report.configure_report;
var queryFunc = {
  4: queryClassModel,
  5: queryAutoClassModel
};
var home = {
  caption: 'Home',
  icon: 'home',
  Cmp: /*#__PURE__*/React.createElement(Home, null),
  key: 'Home',
  unClosable: true
};
export default {
  ...
  reducers: {
    ...
    addTab: function addTab(state, _ref3) {
      ...
      CAPTION = CAPTION ? CAPTION : isEnglish ? record.ENNAME : record.NAME;
      ...
      if (!isExists) {
        if (clickedPanes[namespace]) {
          ...
          if (FACETYPE === 6) {
            ...
            var params = PARAMS || {};
            Cmp = Engine(_objectSpread(_objectSpread({}, modelData), {}, {
              params: params,
              namespace: namespace,
              CAPTION: CAPTION
            }));
          } else if (FACETYPE && FACETYPE !== 8) {
            var newModeData = parseTreeMeta(modelData); // 解构包含META属性的多层树结构

            Cmp = Engine(_objectSpread(_objectSpread({}, newModeData), {}, {
              namespace: namespace,
              CAPTION: CAPTION ? CAPTION : isEnglish ? record.ENNAME : record.NAME
            }));
          } else {
            var page = customPage.find(function (item) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 10:
              ...
              reportConfig = JSON.parse(Base64.decode(data.dataList));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 11:
              ...
              _context4.next = 17;
              return call(queryFunc[FACETYPE] || querySingleModel, _objectSpread(_objectSpread({}, PARAMS), {}, {
                pageId: ID,
                faceType: FACETYPE
              }));
              ...
              if (modelData.dataClassField && modelData.dataClassField.editParams) {
                ...
                if (valuseLen) {
                  ...
                  for (i = 0; i < valuseLen; i++) {
                    modelData.bgcRandomTabs.push(rgbRandom());
                  }
                }
              } // 2. 生成页面
            ...
            case 31:
              ...
              _context4.next = 36;
              return call(_queryDataClassFieldTotal, {
                pageIds: [ID]
              });
              ...
              if (PARAMS && PARAMS.isClass && modelData.dataClassField && modelData.dataClassField.editParams) {
                ...
                if (_valuseLen) {
                  ...
                  for (_i = 0; _i < _valuseLen; _i++) {
                    _data.bgcRandomTabs.push(rgbRandom());
                  }
                }
              }
