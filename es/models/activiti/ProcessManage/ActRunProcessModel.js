...
import { queryItem, queryObjFields } from '../../../service/metaApi';
import { handleProcess, processGetRunProcess, processGetRunProcessSearch, processRevoke, processTransact, queryProcessNode, queryProcessNodeForm, rebuttable, rejectTo, taskTransfer } from '../../../service/processApi';
import { deptGetUserEditor } from '../../../service/systemApi';
import { queryRelationPropertyQueryApi } from '../../../utils/queryTabConfigRelationApi';
import { ergodicRoot, generatorTableKey, judgeModel } from '../../../utils/utils';
export default {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              _context2.next = 10;
              return call(queryProcessNodeForm, {
                processDefinitionId: processDefinitionId,
                objectNo: objectNo
              });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 4;
              return call(handleProcess, payload);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 4;
              return call(taskTransfer, params);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 4;
              return call(processRevoke, params);
