...
/*
 * @Description: 配置平台通用model
 */
import { queryObject, queryWorkObject, searchWorkObject, queryItem as _queryItem, delObject, editObject, addObject, searchObject, addItem, editItem as _editItem, delItem as _delItem, upgradeObject, cancelUpgradeObject, synchroObject, queryRootItem, editRootItem as _editRootItem, addRootItem, delRootItem as _delRootItem, copyObject, reorder, queryGlobalField, changeFile as _changeFile, refreshMeta } from '../../../service/metaApi';
import { message } from 'antd';
import { parseMeta } from '../../../utils/utils';
import { queryModelMap, queryRelationPropertyQueryApi, queryRelationPropertySecondPath, metaObjectParameters } from '../../../utils/queryTabConfigRelationApi';
export default {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              tn = queryModelMap(tableName); // console.log(objectType)

              _context2.next = 10;
              return call(objectType === 'workObject' ? searchWorkObject : searchObject, {
                tn: tn,
                keyWord: queryWord,
                paging: true,
                page: pageNumber,
      ...
      return _regeneratorRuntime().wrap(function edit$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 17:
              _context3.next = 19;
              return call(editObject, {
                id: record.ID,
                meta: values,
                tn: tn,
                state: record.STATE
              }, queryRelationPropertySecondPath(tn), requestType);
            ...
            case 31:
              _context3.next = 33;
              return call(addObject, {
                tableName: tableName,
                meta: _objectSpread(_objectSpread({}, values), {}, {
                  VER: 0
                })
              }, queryRelationPropertySecondPath(tn), _requestType);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              _context6.next = 8;
              return call(cancelUpgradeObject, {
                id: rows[0].ID,
                tableName: tableName
              });
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 8:
              ...
              if (data) {
                message.info(data.hint); // yield put({ type: 'query', payload: { namespace, objectType: 'workObject', activeTab: '2' } })
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 4:
              ...
              tn = queryModelMap(tableName);
              path = queryRelationPropertyQueryApi(tn, objectType);
              if (objectANamespace === 'navMenu') path = '/metaNavigation/getNavigationMenu';
              _context11.next = 11;
              return call(tableName === 'META_OBJECT_GRID_FIELD' ? queryGlobalField : _queryItem, {
                tn: tn,
                objectId: PID
              }, path);
          ...
          switch (_context12.prev = _context12.next) {
            ...
            case 21:
              ...
              */
              ...
              _context12.next = 24;
              return call(_editItem, metaObjectParameters(tn, {
                values: values,
                record: record,
                namespace: namespace,
                PID: PID,
                parentState: parentState
              }, requestType), objectANamespace === 'navMenu' ? '/metaNavigation' : queryRelationPropertySecondPath(tn), requestType);
            ...
            case 41:
              ...
              */
              ...
              _context12.next = 44;
              return call(addItem, metaObjectParameters(tn, {
                values: values,
                record: record,
                namespace: namespace,
                PID: PID,
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 4:
              ...
              tn = queryModelMap(tableName); // console.log(tn, rows, namespace)
            ...
            case 17:
              ...
              _context13.next = 20;
              return call(_delItem, metaObjectParameters(tn, {
                rows: rows,
                namespace: namespace,
                PID: PID,
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 4:
              ...
              tn = queryModelMap(objectTableName);
              _context14.next = 9;
              return call(_queryItem, {
                tn: tn,
                rootId: rootId
              }, queryRelationPropertyQueryApi(tn, objectType));
            ...
            case 9:
              ...
              objectDataList = parseMeta(data.dataList);
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            ...
            case 4:
              ...
              tn = queryModelMap(objectTableName); // console.log(values, record, namespace, rootId, tn)
            ...
            case 15:
              _context15.next = 17;
              return call(_editRootItem, metaObjectParameters(tn, {
                values: values,
                record: record,
                namespace: namespace,
                rootId: rootId,
            ...
            case 29:
              _context15.next = 31;
              return call(addRootItem, metaObjectParameters(tn, {
                values: values,
                record: record,
                namespace: namespace,
                rootId: rootId,
                PID: PID,
                rootPid: rootPid
              }, _requestType2), queryRelationPropertySecondPath(tn), _requestType2);
      ...
      return _regeneratorRuntime().wrap(function delRootItem$(_context16) {
        while (1) {
          switch (_context16.prev = _context16.next) {
            ...
            case 14:
              _context16.next = 16;
              return call(_delRootItem, metaObjectParameters(tn, {
                rows: rows,
                namespace: namespace,
                rootId: rootId
              }, requestType), queryRelationPropertySecondPath(tn), requestType);
