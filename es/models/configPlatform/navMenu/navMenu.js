...
import { editObject, delObject, synchroObject, reorder as _reorder, addMenu, moveNodeData as _moveNodeData, queryMenu, editNavMenuObjectParams } from '../../../service/metaApi';
import { message } from 'antd';
import { parseMeta } from '../../../utils/utils';
import { queryModelMap, queryRelationPropertySecondPath } from '../../../utils/queryTabConfigRelationApi';
export default {
  namespace: 'navMenu',
  state: {
    dataList: [],
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              newDataList = parseMeta(dataList);
              _context.next = 16;
              return put({
                type: "packet",
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              tn = queryModelMap(tableName); // console.log(values, record, tn)
              ...
              return call(editObject, {
                id: record.ID,
                meta: values
              }, queryRelationPropertySecondPath(tn), 'update');
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return call(editNavMenuObjectParams, {
                id: record.ID,
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              tn = queryModelMap(tableName); // console.log(tn, tableName, rows)

              _context4.next = 9;
              return call(delObject, {
                id: rows[0].ID,
                state: rows[0].STATE
              }, queryRelationPropertySecondPath(tn), 'delete');
