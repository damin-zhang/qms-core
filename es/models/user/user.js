...
import { queryUserInfo, getInitSetUPS as _getInitSetUPS, editUserPassword, editUserInfo } from '../../service/systemApi';
import { changeLanguage, synchroAllObject, openModel, closeModel, migrateModelData as _migrateModelData } from '../../service/metaApi';
import { queryNavigationTotal as _queryNavigationTotal, queryCustomNavigationTotal as _queryCustomNavigationTotal } from '../../service/queryDataApi';
import { ergodicRoot, getPath, parseMeta, setPathList } from '../../utils/utils';
import { message } from 'antd';
import { configPlatform, commonNavigationList } from '../../utils/customPage';
...
try {
  menuData = ergodicRoot(JSON.parse(menuData), '1');
} catch (err) {
  menuData = [];
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return call(closeModel, _objectSpread({}, rest));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return call(changeLanguage, val);
            ...
            case 5:
              ...
              if (sessionStorage.getItem('allowModel') === 'true') {
                dataList = configPlatform.concat(dataList);
                dataList.unshift(commonNavigationList);
                canModeling = true;
              } else {
                dataList.unshift(commonNavigationList);
                canModeling = false;
              ...
              menu = ergodicRoot(dataList, 0); // 装配Path列表, 存入LocalStorage

              pathList = setPathList(menu);
              ...
              menuObject = parseMeta(menuObject);
            ...
            case 29:
              ...
              _menuObject = parseMeta(_menuObject);
      ...
      return _regeneratorRuntime().wrap(function editUser$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 11:
              if (data) message.success(data.hint);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              call = _ref13.call;
              _context6.next = 4;
              return call(editUserPassword, values);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              call = _ref15.call;
              _context7.next = 4;
              return call(_migrateModelData);

            case 4:
              data = _context7.sent;
              if (data) message.success(data.info);
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 4;
              return call(_queryNavigationTotal, {
                pageIds: pageIds
              });
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 4;
              return call(_queryCustomNavigationTotal, {
                pageList: pageList
              });
